...
def make_pipeline():
    ...
    class LensSubtractedPhase(ph.LensSourcePlanePhase):
        ...
        def modify_image(self, image, previous_results):
            ...
            return image - phase_1_results.fit.unmasked_model_image - phase_2_results.fit.unmasked_model_image
...
#    as we learn the common ways for people to write pipelines in PyAutoLens, we'll introduce some syntactical sugar
