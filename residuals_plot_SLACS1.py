...
array_plotters.plot_image(image=obs, xticks=xticks, yticks=yticks, output_path='/home/jammy/Documents/',
                          normalization='symmetric_log', output_filename='SLACS0252_Obs', output_format='png')
...
array_plotters.plot_residuals(residuals=residuals_1_sersic, xticks=xticks, yticks=yticks, norm_min=-0.05, norm_max=0.1,
                              output_path='/home/jammy/Documents/', output_filename='SLACS0252_x1Sersic', output_format='png')
...
array_plotters.plot_residuals(residuals=residuals_2_sersic, xticks=xticks, yticks=yticks, norm_min=-0.05, norm_max=0.1,
                              output_path='/home/jammy/Documents/',
                              output_filename='SLACS0252_x2Sersic', output_format='png')