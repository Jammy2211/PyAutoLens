...
Install autolens (v0.36.2 is the most recent stable build):

```
pip install autolens==0.36.2
```
...
Installation is also available via pip (v0.36.2 is the most recent stable build), however there are reported issues with installing **PyMultiNest** that can make installation difficult, see the file [INSTALL.notes](https://github.com/Jammy2211/PyAutoLens/blob/master/INSTALL.notes)
