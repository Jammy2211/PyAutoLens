...
def compute_residuals(observed_image, model_image):
    """ Calculate the residuals between an observed image_coords and a model of that image_coords, \
    ...
    observed_image : ndarray
        Two dimensional array containing observed image_coords weighted_data
    model_image : nddarray
        Two dimensional array containing model_mapper of the observed image_coords
    """
...
def compute_chi_sq_image(observed_image, model_image, noise):
    """ Calculate the chi-squared image_coords of an observed image_coords, model image_coords and signal_to_noise_ratio map.

    The signal_to_noise_ratio map gives the standard deviation of each image_coords pixel, and is converted to variances (by squaring) in the
    ...
    model_image : nddarray
        Two dimensional array containing model_mapper of the observed image_coords
    noise : nddarray
        Two dimensional array containing the signal_to_noise_ratio (standard deviation) in each observed image_coords pixel.
    """
...
def compute_likelihood(observed_image, model_image, noise):
    """ Calculate the likelihood image_coords of an observed image_coords, model image_coords and signal_to_noise_ratio map. The likelihood is defined as
    ...
    observed_data : ndarray
        Two dimensional array containing the observed image_coords weighted_data
    model_image : nddarray
        Two dimensional array containing the model of the observed image_coords
    noise : nddarray
        Two dimensional array containing the signal_to_noise_ratio (standard deviation) in each observed image_coords pixel
    """
