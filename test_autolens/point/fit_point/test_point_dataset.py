...
def test__fits_dataset__positions_only():
    ...
    fit = al.FitPointDataset(dataset=dataset_0, point_solver=point_solver)
    ...
    fit = al.FitPointDataset(dataset=dataset_1, point_solver=point_solver)
...
def test__fits_dataset__positions_and_flux():
    ...
    fit = al.FitPointDataset(dataset=dataset_0, point_solver=solver)
