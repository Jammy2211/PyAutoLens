...
class TestTags:
    ...
    def test__auto_positions_tag(self):
        ...
        assert settings.auto_positions_factor_tag == "_auto_pos_x1.00"
        settings = al.SettingsLens(
            auto_positions_factor=2.56, auto_positions_minimum_threshold=None
        )
        assert settings.auto_positions_factor_tag == "_auto_pos_x2.56"
        settings = al.SettingsLens(
        ...
        assert settings.auto_positions_factor_tag == "_auto_pos_x2.56_min_0.5"
    ...
    def test__tag(self):
        ...
        assert settings.tag == "lens[pos_1.00_auto_pos_x2.56_min_0.5]"
