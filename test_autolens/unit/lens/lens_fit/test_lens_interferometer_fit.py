...
class TestFitProperties:
    def test__total_inversions(self, lens_interferometer_7):
        ...
        fit = al.LensUVPlaneFit.from_lens_data_and_tracer(
            lens_data=lens_interferometer_7, tracer=tracer
        )
...
class TestCompareToManualProfilesOnly:
    def test___all_lens_fit_quantities__no_hyper_methods(self, lens_interferometer_7):
        ...
        assert lens_interferometer_7.noise_map(return_x2=True) == pytest.approx(
            fit.noise_map()
        )

        model_visibilities = tracer.profile_visibilities_from_grid_and_transformer(
            grid=lens_interferometer_7.grid, transformer=lens_interferometer_7.transformer
        )
        ...
        residual_map = autoarray.fit.fit_util.residual_map_from_data_mask_and_model_data(
            data=lens_interferometer_7.visibilities(),
            mask=lens_interferometer_7.visibilities_mask,
    ...
    #     )
    #
    #     g0_blurred_profile_image_1d = lens_interferometer_7.convolver.convolve_image(
    ...
    #     )
    #
    #     g1_blurred_profile_image_1d = lens_interferometer_7.convolver.convolve_image(
    ...
    #     )
    #
    #     g0_blurred_profile_image_2d = lens_interferometer_7.mapping.scaled_array_2d_from_array_1d(
    #         array_1d=g0_blurred_profile_image_1d
    #     )
    #     g1_blurred_profile_image_2d = lens_interferometer_7.mapping.scaled_array_2d_from_array_1d(
    ...
    #         grid=lens_interferometer_7.grid,
    #         convolver=lens_interferometer_7.convolver,
    #         return_x2=True,
    #     )
    #
    ...
    #         grid=lens_interferometer_7.grid, psf=lens_interferometer_7.psf
    #     )
    #
    #     assert (
...
#             grid=lens_interferometer_7.grid, pixelization_grid=None
#         )
#         inversion = al.Inversion.from_data_1d_mapper_and_regularization(
#             mapper=mapper,
#             regularization=reg,
#             image_1d=lens_interferometer_7.visibilities(),
#             noise_map=lens_interferometer_7.noise_map(return_x2=True),
#             convolver=lens_interferometer_7.convolver,
#         )
#
...
#         )
#         residual_map_2d = lens_interferometer_7.mapping.scaled_array_2d_from_array_1d(
...
#         )
#
#         normalized_residual_map_2d = lens_interferometer_7.mapping.scaled_array_2d_from_array_1d(
...
#             noise_map=lens_interferometer_7.noise_map(return_x2=True),
#         )
#         chi_squared_map_2d = lens_interferometer_7.mapping.scaled_array_2d_from_array_1d(
...
#             chi_squared_map=chi_squared_map_2d, mask=lens_interferometer_7.visibilities_mask
#         )
#
...
#         )
#
#     def test___all_lens_fit_quantities__include_hyper_methods(self, lens_interferometer_7):
#
#         hyper_noise_map_max = 0.2
#         lens_interferometer_7.hyper_noise_map_max = hyper_noise_map_max
#
...
#             image=lens_interferometer_7.visibilities()
#         )
#
...
#
#         fit = al.LensUVPlaneFit.from_lens_interferometer_and_tracer(
#             lens_interferometer=lens_interferometer_7,
#             tracer=tracer,
...
#         ] = hyper_noise_map_max
#
#         hyper_noise_map_2d = lens_interferometer_7.mapping.scaled_array_2d_from_array_1d(
...
#
#         mapper = pix.mapper_from_grid_and_pixelization_grid(
#             grid=lens_interferometer_7.grid, inversion_uses_border=False
#         )
#         inversion = al.Inversion.from_data_1d_mapper_and_regularization(
#             mapper=mapper,
#             regularization=reg,
...
#
#         noise_normalization = af.fit_util.noise_normalization_from_noise_map_and_mask(
#             mask=lens_interferometer_7.visibilities_mask, noise_map=hyper_noise_map_2d
#         )
#
#         likelihood = af.fit_util.likelihood_from_chi_squared_and_noise_normalization(
#             chi_squared=chi_squared, noise_normalization=noise_normalization
...
#         )
#
#         blurred_profile_image_2d = lens_interferometer_7.mapping.scaled_array_2d_from_array_1d(
...
#             lens_interferometer_7.visibilities() - blurred_profile_image_1d
#         )
#         profile_subtracted_image_2d = lens_interferometer_7.mapping.scaled_array_2d_from_array_1d(
...
#         model_visibilities_2d = lens_interferometer_7.mapping.scaled_array_2d_from_array_1d(
...
#
#         residual_map = af.fit_util.residual_map_from_data_mask_and_model_data(
#             data=image_1d, mask=lens_interferometer_7.visibilities_mask, model_data=model_visibilities
#         )
#
#         residual_map_2d = lens_interferometer_7.mapping.scaled_array_2d_from_array_1d(
#             array_1d=residual_map
