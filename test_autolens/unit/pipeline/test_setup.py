...
class TestSetupMass:
    def test__no_shear_tag(self):
        ...
        assert setup_mass.no_shear_tag == "__with_shear"

        setup_mass = al.SetupMassLightDark(no_shear=True)
        assert setup_mass.no_shear_tag == "__no_shear"
...
class TestSetupPipeline:
    def test__tag(self):
        ...
        assert (
            ...
            "mass[light_dark__bulge_sersic__disk_exp__mlr_free__with_shear__align_bulge_dark_centre]"
        )
        ...
        assert (
            setup.tag == "setup__"
            "light[parametric__bulge_sersic__disk_exp__light_centre_(1.00,2.00)]__"
            "mass[light_dark__bulge_sersic__disk_exp__mlr_free__no_shear__mass_centre_(3.00,4.00)]__"
