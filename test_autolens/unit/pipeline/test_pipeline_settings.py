...
class TestPipelineGeneralSettings:
    ...
    def test__tag(self):
        ...
        assert (
            pipeline_general_settings.tag == "general__hyper_galaxies_bg_sky_bg_noise"
        )

        pipeline_general_settings = al.PipelineGeneralSettings(
            hyper_galaxies=True, hyper_background_noise=True
        )

        assert pipeline_general_settings.tag == "general__hyper_galaxies_bg_noise"
...
class TestPipelineSourceSettings:
    ...
    def test__tag_from_source(self):
        ...
        source_tag = pipeline_source_settings.tag_from_source(source=galaxy)
...
class TestPipelineLightSettings:
    ...
    def test__disk_as_sersic_tag(self):
        ...
        assert pipeline_light_settings.disk_as_sersic_tag == "__disk_exp"
    ...
    def test__tag(self):
        ...
        assert pipeline_light_settings.tag == "light__align_bulge_disk_phi__disk_exp"
...
class TestPipelineMassSettings:
    ...
    def test__tag(self):
        ...
        assert pipeline_mass_settings.tag == "mass__with_shear__align_bulge_dark_centre"
