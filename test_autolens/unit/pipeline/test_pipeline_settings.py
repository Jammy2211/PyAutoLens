...
class TestPipelineGeneralSettings:
    ...
    def test__hyper_background_noise_tag(self):
        pipeline_general_settings = al.PipelineGeneralSettings(hyper_background_noise=False)
        assert pipeline_general_settings.hyper_galaxies_tag == ""

        pipeline_general_settings = al.PipelineGeneralSettings(hyper_background_noise=True)
    ...
    def test__tag(self):
        ...
        pipeline_general_settings = al.PipelineGeneralSettings(
            hyper_galaxies=True, hyper_image_sky=True, hyper_background_noise=True, with_shear=False)

        assert pipeline_general_settings.tag == "pipeline_tag__hyper_galaxies_bg_sky_bg_noise"

        pipeline_general_settings = al.PipelineGeneralSettings(
            hyper_galaxies=True, hyper_background_noise=True, with_shear=True)

        assert pipeline_general_settings.tag == "pipeline_tag__hyper_galaxies_bg_noise__with_shear"
...
class TestPipelineSourceSettings:
    ...
    def test__lens_light_centre_tagger(self):
        ...
        pipeline_source_settings = al.PipelineSourceSettings(lens_light_centre=(2.0, 2.0))
        assert pipeline_source_settings.lens_light_centre_tag == "__lens_light_centre_(2.00,2.00)"
        pipeline_source_settings = al.PipelineSourceSettings(lens_light_centre=(3.0, 4.0))
        assert pipeline_source_settings.lens_light_centre_tag == "__lens_light_centre_(3.00,4.00)"
        pipeline_source_settings = al.PipelineSourceSettings(lens_light_centre=(3.027, 4.033))
        assert pipeline_source_settings.lens_light_centre_tag == "__lens_light_centre_(3.03,4.03)"
    ...
    def test__lens_mass_centre_tagger(self):
        ...
        pipeline_source_settings = al.PipelineSourceSettings(lens_mass_centre=(2.0, 2.0))
        assert pipeline_source_settings.lens_mass_centre_tag == "__lens_mass_centre_(2.00,2.00)"
        pipeline_source_settings = al.PipelineSourceSettings(lens_mass_centre=(3.0, 4.0))
        assert pipeline_source_settings.lens_mass_centre_tag == "__lens_mass_centre_(3.00,4.00)"
        pipeline_source_settings = al.PipelineSourceSettings(lens_mass_centre=(3.027, 4.033))
        assert pipeline_source_settings.lens_mass_centre_tag == "__lens_mass_centre_(3.03,4.03)"

    def test__align_light_mass_centre_tagger__is_empty_sting_if_both_lens_light_and_mass_centres_input(self):
        pipeline_source_settings = al.PipelineSourceSettings(
        ...
        assert pipeline_source_settings.align_light_mass_centre_tag == "__align_light_mass_centre"
        pipeline_source_settings = al.PipelineSourceSettings(
            lens_light_centre=(0.0, 0.0), lens_mass_centre=(1.0, 1.0), align_light_mass_centre=True,
        )
        assert pipeline_source_settings.align_light_mass_centre_tag == ""
    ...
    def test__tag(self):
        ...
        pipeline_source_settings = al.PipelineSourceSettings(
            lens_light_centre=(1.0, 2.0), lens_mass_centre=(3.0, 4.0), align_light_mass_centre=False, fix_lens_light=True
        )

        assert pipeline_source_settings.tag == "pipeline_tag__pix_voro_image__reg_adapt_bright__lens_light_centre_(1.00,2.00)__lens_mass_centre_(3.00,4.00)__fix_lens_light"
        ...
        assert pipeline_source_settings.tag == "pipeline_tag__pix_rect__reg_const__align_light_mass_centre__fix_lens_light"
...
class TestPipelineLightSettings:
    ...
    def test__bulge_disk_tag(self):
        ...
        assert pipeline_light_settings.align_bulge_disk_tag == "__align_bulge_disk_centre"
        ...
        assert pipeline_light_settings.align_bulge_disk_tag == "__align_bulge_disk_centre_phi"
    ...
    def test__tag(self):
        ...
        assert pipeline_light_settings.tag == "pipeline_tag__align_bulge_disk_phi"
        ...
        assert (
                ...
                == "pipeline_tag__align_bulge_disk_centre_axis_ratio__disk_sersic"
        )
...
class TestPipelineMassSettings:
    ...
    def test__align_light_dark_tagger(self):
        ...
        assert pipeline_mass_settings.align_light_dark_centre_tag == "__align_light_dark_centre"
    ...
    def test__align_bulge_dark_tagger(self):
        ...
        assert pipeline_mass_settings.align_bulge_dark_centre_tag == "__align_bulge_dark_centre"
    ...
    def test__tag(self):
        ...
        assert pipeline_mass_settings.tag == "pipeline_tag__align_light_dark_centre__fix_lens_light"
        ...
        assert (
            ...
            == "pipeline_tag__align_bulge_dark_centre"
        )
