...
class TestCompareToManualProfilesOnly:
    ...
    #         lens_interferometer=masked_interferometer_6x6, tracer=tracer
    #     )
    #
    ...
    #         grid=masked_interferometer_6x6.blurring_grid
    #     )
    #
    ...
    #     )
    #
    #     g0_blurred_profile_image_1d = masked_interferometer_6x6.convolver.convolve_image(
    ...
    #     )
    #
    #     g1_blurred_profile_image_1d = masked_interferometer_6x6.convolver.convolve_image(
    ...
    #     )
    #
    #     g0_blurred_profile_image_2d = masked_interferometer_6x6.mapping.scaled_array_2d_from_array_1d(
    #         array_1d=g0_blurred_profile_image_1d
    #     )
    #     g1_blurred_profile_image_2d = masked_interferometer_6x6.mapping.scaled_array_2d_from_array_1d(
    ...
    #         grid=masked_interferometer_6x6.grid,
    #         convolver=masked_interferometer_6x6.convolver,
    #         return_x2=True,
    #     )
    #
    ...
    #         grid=masked_interferometer_6x6.grid, psf=masked_interferometer_6x6.psf
    #     )
    #
    #     assert (
...
#             grid=masked_interferometer_6x6.grid, pixelization_grid=None
#         )
#         inversion = al.Inversion.from_data_1d_mapper_and_regularization(
#             mapper=mapper,
#             regularization=reg,
#             image_1d=masked_interferometer_6x6.visibilities(),
#             noise_map=masked_interferometer_6x6.noise_map(return_x2=True),
#             convolver=masked_interferometer_6x6.convolver,
#         )
#
...
#         )
#
#         normalized_residual_map_2d = masked_interferometer_6x6.mapping.scaled_array_2d_from_array_1d(
...
#             noise_map=masked_interferometer_6x6.noise_map(return_x2=True),
#         )
#         chi_squared_map_2d = masked_interferometer_6x6.mapping.scaled_array_2d_from_array_1d(
...
#             chi_squared_map=chi_squared_map_2d, mask=masked_interferometer_6x6.visibilities_mask
#         )
#
...
#             image=masked_interferometer_6x6.visibilities()
#         )
#
...
#
#         fit = al.LensUVPlaneFit.from_lens_interferometer_and_tracer(
#             lens_interferometer=masked_interferometer_6x6,
#             tracer=tracer,
...
#
#         mapper = pix.mapper_from_grid_and_pixelization_grid(
#             grid=masked_interferometer_6x6.grid, inversion_uses_border=False
#         )
#         inversion = al.Inversion.from_data_1d_mapper_and_regularization(
#             mapper=mapper,
#             regularization=reg,
...
#
#         noise_normalization = af.fit_util.noise_normalization_from_noise_map_and_mask(
#             mask=masked_interferometer_6x6.visibilities_mask, noise_map=hyper_noise_map_2d
#         )
#
#         likelihood = af.fit_util.likelihood_from_chi_squared_and_noise_normalization(
#             chi_squared=chi_squared, noise_normalization=noise_normalization
...
#         )
#
#         blurred_profile_image_2d = masked_interferometer_6x6.mapping.scaled_array_2d_from_array_1d(
...
#             masked_interferometer_6x6.visibilities() - blurred_profile_image_1d
#         )
#         profile_subtracted_image_2d = masked_interferometer_6x6.mapping.scaled_array_2d_from_array_1d(
...
#         model_visibilities_2d = masked_interferometer_6x6.mapping.scaled_array_2d_from_array_1d(
