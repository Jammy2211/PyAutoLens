...
def test__fit_individuals__source_and_lens__depedent_on_input(
    ...
    assert (
        plot_path + "signal_to_noise_map.png"
        not in plot_patch.paths
    )

    assert (
        plot_path + "model_visibilities.png"
        in plot_patch.paths
    )

    assert (
        plot_path + "residual_map_vs_uv_distances_real.png"
        not in plot_patch.paths
    )
    ...
    assert (
        plot_path + "chi_squared_map_vs_uv_distances_real.png"
        in plot_patch.paths
    )
