...
def test__fit_quantities_are_output(masked_imaging_fit_x2_plane_7x7, include_all, plot_path, plot_patch):
...
def test__fit_sub_plot(masked_imaging_fit_x2_plane_7x7, include_all, plot_path, plot_patch):
...
def test__subtracted_image_of_plane_is_output(
    ...
    assert (
        plot_path + "subtracted_image_of_plane_0.png" in plot_patch.paths
    )
    ...
    assert (
        plot_path + "subtracted_image_of_plane_1.png" in plot_patch.paths
    )
...
def test__fit_individuals__source_and_lens__dependent_on_input(
    ...
    assert (
        plot_path + "normalized_residual_map.png" not in plot_patch.paths
    )
