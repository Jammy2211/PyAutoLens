...
# fits.writeto(simulate=array1, filename=path + "3_ones.fits", overwrite=True)
# fits.writeto(simulate=array2, filename=path + "3_twos.fits")
# fits.writeto(simulate=array3, filename=path + "3_threes.fits")
# fits.writeto(simulate=array4, filename=path + "3_fours.fits")
# fits.writeto(simulate=array5, filename=path + "3_fives.fits")
# fits.writeto(simulate=array6, filename=path + "3_sixes.fits")
# fits.writeto(simulate=array7, filename=path + "3_sevens.fits")
# fits.writeto(simulate=array8, filename=path + "3_eights.fits")
