...
class TestPointMass(object):
    def test__constructor_and_units(self):
        point_mass = al.mass_profiles.PointMass(centre=(1.0, 2.0), einstein_radius=2.0)

        assert point_mass.centre == (1.0, 2.0)
        assert isinstance(point_mass.centre[0], al.Length)
        assert isinstance(point_mass.centre[1], al.Length)
        assert point_mass.centre[0].unit == "arcsec"
        assert point_mass.centre[1].unit == "arcsec"

        assert point_mass.einstein_radius == 2.0
        assert isinstance(point_mass.einstein_radius, al.Length)
    ...
    def test__deflections_of_profile__dont_use_interpolate_and_cache_decorators(self):
        point_mass = al.mass_profiles.PointMass(centre=(-0.3, 0.2), einstein_radius=1.0)
        ...
        interp_deflections = point_mass.deflections_from_grid(
    ...
    # def test__mass(self):
    #
    #     point_mass = al.mass_profiles.PointMass(centre=(0.0, 0.0), einstein_radius=1.91716)
    #
...
class TestCoredPowerLaw(object):
    def test__constructor_and_units(self):
        ...
        assert isinstance(cored_power_law.centre[0], al.Length)
        assert isinstance(cored_power_law.centre[1], al.Length)
        ...
        assert isinstance(cored_power_law.einstein_radius, al.Length)
        ...
        assert isinstance(cored_power_law.core_radius, al.Length)
        ...
        cored_power_law = al.mass_profiles.SphericalCoredPowerLaw(
    ...
    def test__surfce_density__change_geometry(self):
        ...
        cored_power_law_1 = al.mass_profiles.EllipticalCoredPowerLaw(
    ...
    def test__spherical_and_elliptical_match(self):
        elliptical = al.mass_profiles.EllipticalCoredPowerLaw(
            centre=(1.1, 1.1),
            axis_ratio=1.0,
            phi=0.0,
            einstein_radius=3.0,
        ...
        spherical = al.mass_profiles.SphericalCoredPowerLaw(
...
class TestPowerLaw(object):
    def test__constructor_and_units(self):
        ...
        assert isinstance(power_law.centre[0], al.Length)
        assert isinstance(power_law.centre[1], al.Length)
        ...
        assert isinstance(power_law.einstein_radius, al.Length)
        ...
        assert isinstance(power_law.core_radius, al.Length)
    ...
    def test__compare_to_cored_power_law(self):
        ...
        assert power_law.deflections_from_grid(
            ...
            cored_power_law.deflections_from_grid(grid=grid),
            1e-3,
        )
        assert power_law.deflections_from_grid(
            grid=grid
    ...
    def test__spherical_and_elliptical_match(self):
        elliptical = al.mass_profiles.EllipticalPowerLaw(
            centre=(1.1, 1.1),
            axis_ratio=0.9999,
            phi=0.0,
            einstein_radius=3.0,
        ...
        spherical = al.mass_profiles.SphericalPowerLaw(
    ...
    def test__deflections_of_elliptical_profile__dont_use_interpolate_and_cache_decorators(
        ...
        interp_deflections = power_law.deflections_from_grid(
            grid=regular_with_interp
        )
...
class TestCoredIsothermal(object):
    def test__constructor_and_units(self):
        ...
        assert isinstance(cored_isothermal.centre[0], al.Length)
        assert isinstance(cored_isothermal.centre[1], al.Length)
        ...
        assert isinstance(cored_isothermal.einstein_radius, al.Length)
        ...
        assert isinstance(cored_isothermal.core_radius, al.Length)
    ...
    def test__compare_to_cored_power_law(self):
        power_law = al.mass_profiles.EllipticalCoredIsothermal(
            centre=(0.0, 0.0),
            axis_ratio=0.5,
            phi=45.0,
            einstein_radius=1.0,
    ...
    def test__spherical_and_elliptical_match(self):
        elliptical = al.mass_profiles.EllipticalCoredIsothermal(
            centre=(1.1, 1.1),
            axis_ratio=0.9999,
            phi=0.0,
            einstein_radius=3.0,
        ...
        spherical = al.mass_profiles.SphericalCoredIsothermal(
...
class TestIsothermal(object):
    def test__constructor_and_units(self):
        ...
        assert isinstance(isothermal.centre[1], al.Length)
        ...
        assert isinstance(isothermal.einstein_radius, al.Length)
        ...
        assert isinstance(isothermal.core_radius, al.Length)
    ...
    def test__deflections_of_elliptical_profile__dont_use_interpolate_and_cache_decorators(
        ...
        interp_deflections = isothermal.deflections_from_grid(
            grid=regular_with_interp
        )
        interpolator = al.Interpolator.from_mask_grid_and_pixel_scale_interpolation_grids(
            mask=mask, grid=grid, pixel_scale_interpolation_grid=0.5
...
def test__reshape_decorators():
    ...
    assert convergence.in_2d_binned.shape == (3,3)
    assert convergence.in_1d_binned.shape == (9,)
    assert convergence.in_2d.shape == (6, 6)
    assert convergence.in_1d.shape == (36,)

    deflections = isothermal.deflections_from_grid(grid=grid)

    assert deflections.in_2d_binned.shape == (3, 3, 2)
    assert deflections.in_1d_binned.shape == (9, 2)
    assert deflections.in_2d.shape == (6, 6, 2)
    assert deflections.in_1d.shape == (36, 2)