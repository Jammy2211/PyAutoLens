...
mask_x1 = aa.Mask(array_2d=np.array([[False]]), pixel_scales=1.0, sub_size=1)
grid_10 = aa.Grid(sub_grid_1d=np.array([[1.0, 0.0]]), mask=mask_x1)
grid_01 = aa.Grid(sub_grid_1d=np.array([[0.0, 1.0]]), mask=mask_x1)
grid_11 = aa.Grid(sub_grid_1d=np.array([[1.0, 1.0]]), mask=mask_x1)
grid_00 = aa.Grid(sub_grid_1d=np.array([[0.0, 0.0]]), mask=mask_x1)
grid_minus_11 = aa.Grid(sub_grid_1d=np.array([[-1.0, -1.0]]), mask=mask_x1)
grid_03 = aa.Grid(sub_grid_1d=np.array([[0.0, 3.0]]), mask=mask_x1)
grid_34 = aa.Grid(sub_grid_1d=np.array([[3.0, 4.0]]), mask=mask_x1)
...
class TestEllipticalProfile(object):
    class TestConstuctorUnits(object):
        def test__constructor_and_units(self):
            profile = al.geometry_profiles.EllipticalProfile(
