...
def test__operate_image__blurred_images_2d_via_psf_from__for_tracer_gives_list_of_planes(
    ...
    plane_0 = al.Plane(redshift=0.5, galaxy_list=[g0])
    plane_1 = al.Plane(redshift=1.0, galaxy_list=[g1])
...
def test__operate_image__visibilities_of_planes_from_grid_and_transformer(
    ...
    plane_0 = al.Plane(redshift=0.5, galaxy_list=[g0])
    plane_1 = al.Plane(redshift=0.5, galaxy_list=[g1])
    plane_2 = al.Plane(redshift=1.0, galaxy_list=[al.Galaxy(redshift=1.0)])
...
def test__operate_lens__sums_individual_quantities():
    ...
    plane = al.Plane(galaxy_list=[galaxy_0, galaxy_1])

    tracer = al.Tracer(
        planes=[plane, al.Plane(redshift=1.0, galaxy_list=None)],
