...
def make_pipeline(name, path_prefix, search=af.DynestyStatic()):
    ...
    phase2 = al.PhaseImaging(
        ...
        galaxies=dict(
            ...
            source=al.GalaxyModel(
                redshift=1.0,
                pixelization=phase1.result.instance.galaxies.source.pixelization_prior_model,
                regularization=phase1.result.instance.galaxies.source.regularization_prior_model,
            ),
        ),
        search=search,
    )
