...
al.plot.fit_imaging.subplot_for_plane(
    fit=fit, plane_index=1, plot_in_kpc=True, include_image_plane_pix=True, include_caustics=True,
)

al.plot.fit_imaging.subplot_for_plane(
    fit=fit, plane_index=1, plot_in_kpc=False, include_image_plane_pix=True, include_caustics=True,
)
