...
def plot_fit_subplot_lens_plane_only(fit_hyper, fit, should_plot_mask=True, positions=None,
    ...
    lens_plotter_util.plot_image(fit=fit_hyper, mask=mask, positions=positions,
    ...
    lens_plotter_util.plot_model_data(fit=fit_hyper, mask=mask, as_subplot=True,
                                      units=units, kpc_per_arcsec=kpc_per_arcsec, figsize=figsize, aspect=aspect,
    ...
    lens_plotter_util.plot_residual_map(fit=fit_hyper, mask=mask, as_subplot=True,
                                        units=units, kpc_per_arcsec=kpc_per_arcsec, figsize=figsize, aspect=aspect,
                                        cmap=cmap, norm=norm, norm_min=norm_min, norm_max=norm_max, linthresh=linthresh, linscale=linscale,
                                        cb_ticksize=cb_ticksize, cb_fraction=cb_fraction, cb_pad=cb_pad,
                                        titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize, xyticksize=xyticksize,
    ...
    lens_plotter_util.plot_contribution_maps(fit=fit_hyper, mask=mask, as_subplot=True,
                                             units=units, kpc_per_arcsec=kpc_per_arcsec, figsize=figsize, aspect=aspect,
                                             cmap=cmap, norm=norm, norm_min=norm_min, norm_max=norm_max, linthresh=linthresh,
                                             linscale=linscale,
                                             cb_ticksize=cb_ticksize, cb_fraction=cb_fraction, cb_pad=cb_pad,
    ...
    lens_plotter_util.plot_chi_squared_map(fit=fit_hyper, mask=mask, as_subplot=True,
                                           units=units, kpc_per_arcsec=kpc_per_arcsec, figsize=figsize, aspect=aspect,
                                           cmap=cmap, norm=norm, norm_min=norm_min, norm_max=norm_max, linthresh=linthresh,
                                           linscale=linscale,
                                           cb_ticksize=cb_ticksize, cb_fraction=cb_fraction, cb_pad=cb_pad,
    ...
    lens_plotter_util.plot_noise_map(fit=fit, mask=mask, as_subplot=True,
                                     units=units, kpc_per_arcsec=kpc_per_arcsec, figsize=figsize, aspect=aspect,
                                     cmap=cmap, norm=norm, norm_min=norm_min, norm_max=norm_max, linthresh=linthresh,
                                     linscale=linscale,
                                     cb_ticksize=cb_ticksize, cb_fraction=cb_fraction, cb_pad=cb_pad,
    ...
    lens_plotter_util.plot_noise_map(fit=fit_hyper, mask=mask, as_subplot=True,
                                     units=units, kpc_per_arcsec=kpc_per_arcsec, figsize=figsize, aspect=aspect,
                                     cmap=cmap, norm=norm, norm_min=norm_min, norm_max=norm_max, linthresh=linthresh,
                                     linscale=linscale,
                                     cb_ticksize=cb_ticksize, cb_fraction=cb_fraction, cb_pad=cb_pad,
...
def plot_fit_individuals_lens_plane_only(fit_hyper, fit, units='kpc', output_path=None, output_format='show'):
    ...
    if plot_lens_fit_contributions:
        lens_plotter_util.plot_contribution_maps(fit=fit, mask=mask, units=units, kpc_per_arcsec=kpc_per_arcsec,
                                                 output_path=output_path, output_format=output_format)

    if plot_lens_fit_hyper_noise_map:
        lens_plotter_util.plot_noise_map(fit=fit_hyper, mask=mask, units=units, kpc_per_arcsec=kpc_per_arcsec,
