...
def plot_fit_subplot_lens_and_source_planes(fit, should_plot_mask=True, should_plot_source_grid=False, positions=None,
    ...
    if fit.tracer.image_plane.has_light_profile:
        ...
        lens_plotter_util.plot_model_image_of_planes(
            fit=fit, plot_foreground=True, mask=mask, as_subplot=True,
            units=units, kpc_per_arcsec=kpc_per_arcsec, figsize=figsize, aspect=aspect,
            cmap=cmap, norm=norm, norm_min=norm_min, norm_max=norm_max, linthresh=linthresh, linscale=linscale,
            cb_ticksize=cb_ticksize, cb_fraction=cb_fraction, cb_pad=cb_pad,
    ...
    lens_plotter_util.plot_model_image_of_planes(
        fit=fit, plot_source=True, mask=mask, as_subplot=True,
        units=units, kpc_per_arcsec=kpc_per_arcsec, figsize=figsize, aspect=aspect,
        cmap=cmap, norm=norm, norm_min=norm_min, norm_max=norm_max, linthresh=linthresh, linscale=linscale,
        cb_ticksize=cb_ticksize, cb_fraction=cb_fraction, cb_pad=cb_pad,
...
def plot_fit_individuals_lens_and_source_planes(fit, units='kpc', output_path=None, output_format='show',
    ...
    if plot_lens_fit_lens_subtracted_image:
        ...
        lens_plotter_util.plot_lens_subtracted_image(
            fit=fit, units=units, mask=mask, kpc_per_arcsec=kpc_per_arcsec,
            output_path=output_path, output_format=output_format)
    ...
    if plot_lens_fit_lens_model_image:
        ...
        lens_plotter_util.plot_model_image_of_planes(
            fit=fit, mask=mask, plot_foreground=True,
    ...
    if plot_lens_fit_source_model_image:
        ...
        lens_plotter_util.plot_model_image_of_planes(
            fit=fit, mask=mask, plot_source=True,
            units=units, kpc_per_arcsec=kpc_per_arcsec,
    ...
    if plot_lens_fit_residuals:
        ...
        lens_plotter_util.plot_residual_map(
            fit=fit, mask=mask, units=units, kpc_per_arcsec=kpc_per_arcsec,
            output_path=output_path, output_format=output_format)
