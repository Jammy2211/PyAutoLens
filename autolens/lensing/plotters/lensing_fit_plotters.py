...
def plot_fit_subplot_lens_plane_only(fit, should_plot_mask=True, positions=None, should_plot_image_plane_pix=True,
    ...
    mask = lensing_plotter_util.get_mask(fit=fit, should_plot_mask=should_plot_mask)
    ...
    lensing_plotter_util.plot_image(fit=fit, mask=mask, positions=positions, image_plane_pix_grid=image_plane_pix_grid, 
               as_subplot=True,
    ...
    lensing_plotter_util.plot_model_image(fit=fit, mask=mask, as_subplot=True,
                      units=units, kpc_per_arcsec=kpc_per_arcsec, figsize=figsize, aspect=aspect,
    ...
    lensing_plotter_util.plot_residual_map(fit=fit, mask=mask, as_subplot=True,
                      units=units, kpc_per_arcsec=kpc_per_arcsec, figsize=figsize, aspect=aspect,
                      cmap=cmap, norm=norm, norm_min=norm_min, norm_max=norm_max, linthresh=linthresh,
                      linscale=linscale,
                      cb_ticksize=cb_ticksize, cb_fraction=cb_fraction, cb_pad=cb_pad,
...
def plot_fit_subplot_lens_and_source_planes(fit, should_plot_mask=True, should_plot_source_grid=False, positions=None,
    ...
    lensing_plotter_util.plot_image(fit=fit, mask=mask, positions=positions,
    ...
    if fit.tracer.image_plane.has_light_profile:
        ...
        lensing_plotter_util.plot_model_image_of_plane(fit=fit, plane_index=0, mask=mask, as_subplot=True,
                                                   units=units, kpc_per_arcsec=kpc_per_arcsec, figsize=figsize, aspect=aspect,
                                                   cmap=cmap, norm=norm, norm_min=norm_min, norm_max=norm_max, linthresh=linthresh,
                                                   linscale=linscale,
                                                   cb_ticksize=cb_ticksize, cb_fraction=cb_fraction, cb_pad=cb_pad,
    ...
    lensing_plotter_util.plot_model_image_of_plane(fit=fit, plane_index=1, mask=mask, as_subplot=True,
                                               units=units, kpc_per_arcsec=kpc_per_arcsec, figsize=figsize, aspect=aspect,
                                               cmap=cmap, norm=norm, norm_min=norm_min, norm_max=norm_max, linthresh=linthresh,
                                               linscale=linscale,
                                               cb_ticksize=cb_ticksize, cb_fraction=cb_fraction, cb_pad=cb_pad,
...
def plot_fit_individuals_lens_and_source_planes(fit, units='kpc', output_path=None, output_format='show'):
    ...
    if plot_lensing_fitting_model_image:
        lensing_plotter_util.plot_model_image(fit=fit, units=units, mask=mask, kpc_per_arcsec=kpc_per_arcsec,
                                          output_path=output_path, output_format=output_format)

    if plot_lensing_fitting_lens_model_image:
        lensing_plotter_util.plot_model_image_of_plane(fit=fit, plane_index=0, mask=mask, units=units,
                                                   kpc_per_arcsec=kpc_per_arcsec,
                                                   output_path=output_path, output_filename='fit_lens_plane_model_image',
                                                   output_format=output_format)

    if plot_lensing_fitting_source_model_image:
        lensing_plotter_util.plot_model_image_of_plane(fit=fit, plane_index=1, mask=mask, units=units,
                                                   kpc_per_arcsec=kpc_per_arcsec,
