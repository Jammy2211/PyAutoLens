...
class LensingImageStack(object):
...
class LensingHyperImageStack(LensingImageStack):
    ...
    def __array_finalize__(self, obj):
        super(LensingHyperImageStack, self).__array_finalize__(obj)
        if isinstance(obj, LensingHyperImageStack):
