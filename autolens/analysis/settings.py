...
class SettingsLens:
    def __init__(
        self,
        positions_threshold: Optional[float] = None,
        positions_resampling: bool = False,
        positions_likelihood_penalty: bool = False,
        positions_likelihood_penalty_fast: bool = False,
        ...
        self.positions_resampling = positions_resampling
        self.positions_likelihood_penalty = positions_likelihood_penalty
        self.positions_likelihood_penalty_fast = positions_likelihood_penalty_fast
    ...
    def log_likelihood_penalty_base_from(
        ...
        log_Likelihood_penalty_base - log_likelihood_penalty_factor * (max_source_plane_separation - positions_threshold)

        The `log_likelihood_penalty` is only used if `max_source_plane_separation > positions_threshold`.
    ...
    def positions_log_likelihood_penalty_from(self, positions, tracer):
        """
        The fast log likelihood penalty scheme returns an alternative penalty log likelihood for any model where the
        ...
        if not positions_fit.max_separation_within_threshold(self.positions_threshold):
