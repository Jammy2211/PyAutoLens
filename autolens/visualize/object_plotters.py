...
def plot_image_data_from_image(image, output_path=None, output_format='show'):
    ...
    array_plotters.plot_image(
        image=image, xticks=image.xticks, yticks=image.yticks, units='arcsec', xyticksize=40,
    ...
    array_plotters.plot_noise_map(
        noise_map=image.noise_map, xticks=image.xticks, yticks=image.yticks, units='arcsec', xyticksize=40,
        norm='linear', norm_min=None, norm_max=None, linthresh=0.05, linscale=0.01,
        figsize=(20, 15), aspect='auto', cmap='jet', cb_ticksize=20,
    ...
    array_plotters.plot_psf(
        psf=image.psf, xticks=image.xticks, yticks=image.yticks, units='arcsec', xyticksize=40,
        norm='linear', norm_min=None, norm_max=None, linthresh=0.05, linscale=0.01,
        figsize=(20, 15), aspect='auto', cmap='jet', cb_ticksize=20,
