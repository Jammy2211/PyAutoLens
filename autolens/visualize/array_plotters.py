...
def plot_image(image, xticks=None, yticks=None, units='pixels', xyticksize=40,
    ...
    plot_array(array=image, xticks=xticks, yticks=yticks, units=units, xyticksize=xyticksize,
...
def plot_noise_map(noise_map, xticks=None, yticks=None, units='pixels', xyticksize=40,
                   norm='linear', norm_min=None, norm_max=None, linthresh=0.05, linscale=0.01,
                   figsize=(20, 15), aspect='auto', cmap='jet', cb_ticksize=20,
    ...
    plot_array(array=noise_map, xticks=xticks, yticks=yticks, units=units, xyticksize=xyticksize,
               norm=norm, norm_min=norm_min, norm_max=norm_max, linthresh=linthresh, linscale=linscale,
               figsize=figsize, aspect=aspect, cmap=cmap, cb_ticksize=cb_ticksize,
               title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize,
               output_path=output_path, output_filename=output_filename, output_format=output_format)

def plot_psf(psf, xticks=None, yticks=None, units='pixels', xyticksize=40,
             norm='linear', norm_min=None, norm_max=None, linthresh=0.05, linscale=0.01,
             figsize=(20, 15), aspect='auto', cmap='jet', cb_ticksize=20,
             title='PSF', titlesize=46, xlabelsize=36, ylabelsize=36,
             output_path=None, output_filename='psf', output_format='show'):

    plot_array(array=psf, xticks=xticks, yticks=yticks, units=units, xyticksize=xyticksize,
               norm=norm, norm_min=norm_min, norm_max=norm_max, linthresh=linthresh, linscale=linscale,
               figsize=figsize, aspect=aspect, cmap=cmap, cb_ticksize=cb_ticksize,
               title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize,
               output_path=output_path, output_filename=output_filename, output_format=output_format)
...
def plot_model_image(model_image, xticks=None, yticks=None, units='pixels', xyticksize=40,
    ...
    plot_array(array=model_image, xticks=xticks, yticks=yticks, units=units, xyticksize=xyticksize,
               norm=norm, norm_min=norm_min, norm_max=norm_max, linthresh=linthresh, linscale=linscale,
               figsize=figsize, aspect=aspect, cmap=cmap, cb_ticksize=cb_ticksize,
               title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize,
               output_path=output_path, output_filename=output_filename, output_format=output_format)
...
def plot_residuals(residuals, xticks=None, yticks=None, units='pixels', xyticksize=40,
    ...
    plot_array(array=residuals, xticks=xticks, yticks=yticks, units=units, xyticksize=xyticksize,
               norm=norm, norm_min=norm_min, norm_max=norm_max, linthresh=linthresh, linscale=linscale,
               figsize=figsize, aspect=aspect, cmap=cmap, cb_ticksize=cb_ticksize,
               title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize,
               output_path=output_path, output_filename=output_filename, output_format=output_format)

def plot_chi_squareds(chi_squareds, xticks=None, yticks=None, units='pixels', xyticksize=40,
...
def plot_scaled_noise_map(scaled_noise_map, xticks=None, yticks=None, units='pixels', xyticksize=40,
                          norm='linear', norm_min=None, norm_max=None, linthresh=0.05, linscale=0.01,
                          figsize=(20, 15), aspect='auto', cmap='jet', cb_ticksize=20,
    ...
    plot_array(array=scaled_noise_map, xticks=xticks, yticks=yticks, units=units, xyticksize=xyticksize,
               norm=norm, norm_min=norm_min, norm_max=norm_max, linthresh=linthresh, linscale=linscale,
               figsize=figsize, aspect=aspect, cmap=cmap, cb_ticksize=cb_ticksize,
               title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize,
               output_path=output_path, output_filename=output_filename, output_format=output_format)

def plot_scaled_chi_squareds(scaled_chi_squareds, xticks=None, yticks=None, units='pixels', xyticksize=40,
                             norm='linear', norm_min=None, norm_max=None, linthresh=0.001, linscale=0.001,
                             figsize=(20, 15), aspect='auto', cmap='jet', cb_ticksize=20,
    ...
    plot_array(array=scaled_chi_squareds, xticks=xticks, yticks=yticks, units=units, xyticksize=xyticksize,
               norm=norm, norm_min=norm_min, norm_max=norm_max, linthresh=linthresh, linscale=linscale,
               figsize=figsize, aspect=aspect, cmap=cmap, cb_ticksize=cb_ticksize,
               title=title, titlesize=titlesize, xlabelsize=xlabelsize, ylabelsize=ylabelsize,
               output_path=output_path, output_filename=output_filename, output_format=output_format)

def plot_array(array, xticks, yticks, xyticksize, units,
