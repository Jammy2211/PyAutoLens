...
def plot_contributions(contributions, grid=None, as_subplot=False, xticks=None, yticks=None, units='pixels',
                       xyticksize=40,
                       norm='linear', norm_min=None, norm_max=None, linthresh=0.001, linscale=0.001,
                       figsize=(20, 15), aspect='auto', cmap='jet', cb_ticksize=20,
                       title='Chi Squareds', titlesize=46, xlabelsize=36, ylabelsize=36,
...
def plot_scaled_chi_squareds(scaled_chi_squareds, as_subplot=False, xticks=None, yticks=None, units='pixels',
                             xyticksize=40,
                             norm='linear', norm_min=None, norm_max=None, linthresh=0.001, linscale=0.001,
                             figsize=(20, 15), aspect='auto', cmap='jet', cb_ticksize=20,
