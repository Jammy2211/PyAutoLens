...
def plot_quantity_as_function_of_radius(
    ...
    plot_quantity_vs_radius_data(
        quantity=quantity, radii=radii, plot_axis_type=plot_axis_type, label=label
    )
    plot_vertical_line(
        units=units,
        kpc_per_arcsec=kpc_per_arcsec,
        vertical_line_x_value=effective_radius_line,
        label="Effective Radius",
    )
    plot_vertical_line(
        units=units,
        kpc_per_arcsec=kpc_per_arcsec,
        vertical_line_x_value=einstein_radius_line,
