...
def plot_image(image, plot_origin=True, mask=None, should_plot_border=True, positions=None, grid=None, as_subplot=False,
    ...
    tools_array.plot_array(array=image, origin=origin, mask=mask, should_plot_border=should_plot_border,
