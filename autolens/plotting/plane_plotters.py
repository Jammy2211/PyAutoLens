...
def plot_image_and_source_plane_subplot(image_plane, source_plane, axis_limits=None,
                    units='arcsec', kpc_per_arcsec=None,
    ...
    plot_plane_grid(plane=image_plane, axis_limits=axis_limits, as_subplot=True,
    ...
    plot_plane_grid(plane=source_plane, axis_limits=axis_limits, as_subplot=True,
                    units=units, kpc_per_arcsec=kpc_per_arcsec,
                    pointsize=3, xyticksize=16, titlesize=10, xlabelsize=10, ylabelsize=10,
                    output_path=output_path, output_filename=output_filename, output_format=output_format)
...
def plot_plane_grid(plane, axis_limits=None, as_subplot=False,
                    units='arcsec', kpc_per_arcsec=None,
    ...
    plot_grid.plot_grid(grid=plane.grids.image, axis_limits=axis_limits, as_subplot=as_subplot,
                         units=units, kpc_per_arcsec=kpc_per_arcsec,
