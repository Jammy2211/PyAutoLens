...
def plot_intensities_subplot(galaxy, grid,
...
def plot_surface_density_subplot(galaxy, grid,
                                 units='arcsec', kpc_per_arcsec=None, figsize=None, aspect='equal',
...
def plot_potential_subplot(galaxy, grid,
                           units='arcsec', kpc_per_arcsec=None, figsize=None, aspect='equal',
                           cmap='jet', norm='linear', norm_min=None, norm_max=None, linthresh=0.05, linscale=0.01,
                           cb_ticksize=10, cb_fraction=0.047, cb_pad=0.01,
                           titlesize=10, xlabelsize=10, ylabelsize=10, xyticksize=10,
...
def plot_deflections_y_subplot(galaxy, grid,
                               units='arcsec', kpc_per_arcsec=None, figsize=None, aspect='equal',
                               cmap='jet', norm='linear', norm_min=None, norm_max=None, linthresh=0.05,
                               linscale=0.01,
                               cb_ticksize=10, cb_fraction=0.047, cb_pad=0.01,
