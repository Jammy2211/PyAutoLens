...
class Galaxy(af.ModelObject):
    ...
    def intensities_from_grid(self, grid, return_in_2d=True, return_binned=True):
        ...
        if self.has_light_profile:
            return sum(
                map(
                    lambda p: p.intensities_from_grid(
    ...
    def tangential_critical_curve_from_grid(
            self, grid
    ):
    ...
    def tangential_caustic_from_grid(
            self, grid
    ):
    ...
    def radial_critical_curve_from_grid(
            self, grid
    ):
