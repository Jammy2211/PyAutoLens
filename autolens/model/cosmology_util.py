...
def cosmic_average_density_from_redshift_and_cosmology(
...
def critical_surface_density_between_redshifts_from_redshifts_and_cosmology(
    ...
    angular_diameter_distance_of_redshift_0_to_earth_kpc = angular_diameter_distance_to_earth_from_redshift_and_cosmology(
        redshift=redshift_0, cosmology=cosmology, unit_length="kpc"
    )

    angular_diameter_distance_of_redshift_1_to_earth_kpc = angular_diameter_distance_to_earth_from_redshift_and_cosmology(
        redshift=redshift_1, cosmology=cosmology, unit_length="kpc"
    )

    angular_diameter_distance_between_redshifts_kpc = angular_diameter_distance_between_redshifts_from_redshifts_and_cosmlology(
...
def scaling_factor_between_redshifts_from_redshifts_and_cosmology(
