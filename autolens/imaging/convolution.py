...
class Convolver(object):
    ...
    masked image or the masked image of a mapping in the inversion module.
    ...
    blurring_frame_indexes - The indexes of all unmasked image pixels (not unmasked blurring image pixels) it will \
    blur light into.
