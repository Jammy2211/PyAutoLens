...
class Regularization(object):
    ...
    def __init__(self, regularization_coefficients):
        ...
        smooth-source solution and prevent over-fitting noise in the image. This is achieved by computing a \
        ...
        linearly invert and fit the image data. Thus, it changes the pixelization in a linear manner, ensuring that \
...
class Weighted(Regularization):
    ...
    def pixel_signals_from_images(self, pixels, image_to_pixelization, galaxy_image):
        ...
        regularizations weights are defined identically for any image units or signal-to-noise ratio.
