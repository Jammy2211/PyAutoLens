    ...
    class Analysis(af.Analysis):
        ...
        def visualize(self, instance, during_analysis):
            ...
            if self.visualizer.plot_hyper_galaxy_subplot:
                ...
                hyper_model_image_2d = self.lens_data.grid.mask.mapping.scaled_array_2d_from_array_1d(
                    array_1d=self.hyper_model_image_1d
                )

                hyper_galaxy_image_2d = self.lens_data.grid.mask.mapping.scaled_array_2d_from_array_1d(
