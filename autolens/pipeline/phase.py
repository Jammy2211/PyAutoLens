...
class LensPlanePhase(PhaseImaging):
    ...
    def __init__(self, lens_galaxies=None, optimizer_class=non_linear.MultiNest, sub_grid_size=2, image_psf_shape=None,
                 mask_function=default_mask_function, cosmology=cosmo.Planck15, phase_name="lens_only_phase",
                 auto_link_priors=False):
    ...
    class Result(PhaseImaging.Result):
        ...
        def __init__(self, constant, likelihood, variable, analysis):
            ...
            self.padded_model_image = self.fit.unmasked_model_image
            self.lens_galaxy_padded_model_images = self.fit.unmasked_model_image_of_galaxies
