...
def plot_lens_fit_for_phase(
        ...
        should_plot_pixelization_residuals,
        should_plot_pixelization_normalized_residuals,
        should_plot_pixelization_chi_squareds,
    ...
    lens_fit_plotters.plot_fit_individuals(
        ...
        should_plot_pixelization_residuals=should_plot_pixelization_residuals,
        should_plot_pixelization_normalized_residuals=should_plot_pixelization_normalized_residuals,
        should_plot_pixelization_chi_squareds=should_plot_pixelization_chi_squareds,
        should_plot_pixelization_regularization_weights=should_plot_pixelization_regularization_weights,
    ...
    if not during_analysis:
        ...
        if should_plot_all_at_end_png:
            ...
            lens_fit_plotters.plot_fit_individuals(
                ...
                should_plot_pixelization_residuals=True,
                should_plot_pixelization_normalized_residuals=True,
                should_plot_pixelization_chi_squareds=True,
                should_plot_pixelization_regularization_weights=True,
