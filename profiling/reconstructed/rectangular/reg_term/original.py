...
@tools.tick_toc_x1
def lsst_solution():
    lsst_reconstructed.regularization_term_from_reconstruction()

@tools.tick_toc_x1
def euclid_solution():
    euclid_reconstructed.regularization_term_from_reconstruction()

@tools.tick_toc_x1
def hst_solution():
    hst_reconstructed.regularization_term_from_reconstruction()

@tools.tick_toc_x1
def hst_up_solution():
    hst_up_reconstructed.regularization_term_from_reconstruction()

@tools.tick_toc_x1
def ao_solution():
    ao_reconstructed.regularization_term_from_reconstruction()
