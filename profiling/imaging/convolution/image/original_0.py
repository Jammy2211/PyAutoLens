...
lsst_kernel_convolver = KernelConvolverOriginal(kernel=lsst.image.psf.trim(psf_shape),
...
euclid_kernel_convolver = KernelConvolverOriginal(kernel=euclid.image.psf.trim(psf_shape),
...
hst_kernel_convolver = KernelConvolverOriginal(kernel=hst.image.psf.trim(psf_shape),
...
hst_up_kernel_convolver = KernelConvolverOriginal(kernel=hst_up.image.psf.trim(psf_shape),
