...
assert lsst_kernel_convolver.convolve_image(image_array=lsst_image, blurring_array=lsst_blurring_image) == \
       pytest.approx(lsst_kernel_convolver.convolve_image_jitted(image_array=lsst_image, blurring_array=lsst_blurring_image), 1e-4)
...
assert euclid_kernel_convolver.convolve_image(image_array=euclid_image, blurring_array=euclid_blurring_image) == \
       pytest.approx(euclid_kernel_convolver.convolve_image_jitted(image_array=euclid_image, blurring_array=euclid_blurring_image), 1e-4)
...
assert hst_kernel_convolver.convolve_image(image_array=hst_image, blurring_array=hst_blurring_image) == \
       pytest.approx(hst_kernel_convolver.convolve_image_jitted(image_array=hst_image, blurring_array=hst_blurring_image), 1e-4)
...
assert hst_up_kernel_convolver.convolve_image(image_array=hst_up_image, blurring_array=hst_up_blurring_image) == \
       pytest.approx(hst_up_kernel_convolver.convolve_image_jitted(image_array=hst_up_image, blurring_array=hst_up_blurring_image), 1e-4)
...
assert ao_kernel_convolver.convolve_image(image_array=ao_image, blurring_array=ao_blurring_image) == \
       pytest.approx(ao_kernel_convolver.convolve_image_jitted(image_array=ao_image, blurring_array=ao_blurring_image), 1e-4)
...
def lsst_jit_solution():
    lsst_kernel_convolver.convolve_image_jitted(image_array=lsst_image, blurring_array=lsst_blurring_image)
...
def euclid_jit_solution():
    euclid_kernel_convolver.convolve_image_jitted(image_array=euclid_image, blurring_array=euclid_blurring_image)
...
def hst_jit_solution():
    hst_kernel_convolver.convolve_image_jitted(image_array=hst_image, blurring_array=hst_blurring_image)
...
def hst_up_jit_solution():
    hst_up_kernel_convolver.convolve_image_jitted(image_array=hst_up_image, blurring_array=hst_up_blurring_image)
...
@tick_toc
def ao_jit_solution():
    ao_kernel_convolver.convolve_image_jitted(image_array=ao_image, blurring_array=ao_blurring_image)
