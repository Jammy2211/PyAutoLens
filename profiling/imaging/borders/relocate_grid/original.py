...
lsst_border = SubGridBorder.from_mask(mask=lsst.mask, sub_grid_size=sub_grid_size)

euclid = profiling_data.setup_class(name='Euclid', pixel_scale=0.1, sub_grid_size=sub_grid_size)
euclid_border = SubGridBorder.from_mask(mask=euclid.mask, sub_grid_size=sub_grid_size)

hst = profiling_data.setup_class(name='HST', pixel_scale=0.05, sub_grid_size=sub_grid_size)
hst_border = SubGridBorder.from_mask(mask=hst.mask, sub_grid_size=sub_grid_size)

hst_up = profiling_data.setup_class(name='HSTup', pixel_scale=0.03, sub_grid_size=sub_grid_size)
hst_up_border = SubGridBorder.from_mask(mask=hst_up.mask, sub_grid_size=sub_grid_size)

ao = profiling_data.setup_class(name='AO', pixel_scale=0.01, sub_grid_size=sub_grid_size)
ao_border = SubGridBorder.from_mask(mask=ao.mask, sub_grid_size=sub_grid_size)
