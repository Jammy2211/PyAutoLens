...
pix = RectangularPixelization()

@tools.tick_toc_x20
def lsst_solution():
    pix.geometry_from_pix_sub_grid(pix_sub_grid=lsst.coords.sub_grid_coords)

@tools.tick_toc_x20
def euclid_solution():
    pix.geometry_from_pix_sub_grid(pix_sub_grid=euclid.coords.sub_grid_coords)

@tools.tick_toc_x20
def hst_solution():
    pix.geometry_from_pix_sub_grid(pix_sub_grid=hst.coords.sub_grid_coords)

@tools.tick_toc_x20
def hst_up_solution():
    pix.geometry_from_pix_sub_grid(pix_sub_grid=hst_up.coords.sub_grid_coords)

@tools.tick_toc_x20
def ao_solution():
    pix.geometry_from_pix_sub_grid(pix_sub_grid=ao.coords.sub_grid_coords)
