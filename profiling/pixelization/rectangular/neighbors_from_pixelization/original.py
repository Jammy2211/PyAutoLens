...
@tools.tick_toc_x10
def solution_10x10():
    pix = RectangularPixelization(shape=(10, 10))
    pix.neighbors_from_pixelization()

@tools.tick_toc_x10
def solution_20x20():
    pix = RectangularPixelization(shape=(20, 20))
    pix.neighbors_from_pixelization()

@tools.tick_toc_x10
def solution_30x30():
    pix = RectangularPixelization(shape=(30, 30))
    pix.neighbors_from_pixelization()

@tools.tick_toc_x10
def solution_40x40():
    pix = RectangularPixelization(shape=(40, 40))
    pix.neighbors_from_pixelization()

@tools.tick_toc_x10
def solution_50x50():
    pix = RectangularPixelization(shape=(50, 50))
    pix.neighbors_from_pixelization()
