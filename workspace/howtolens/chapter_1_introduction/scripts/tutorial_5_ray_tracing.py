...
# 1) The image-plane image, computed by tracing the source model_galaxy's light 'forwards' through the tracer.
...
# 1) Change the lens model_galaxy's einstein radius - what happens to the tracer's image-plane image?
