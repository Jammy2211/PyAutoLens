...
simulate_data.simulate_all_images() # This will populate the 'datas' folder.
...
image = im.load_ccd_data_from_fits(image_path=path + 'datas/regular/regular.fits',
...
image = im.load_ccd_data_from_fits(image_path=path + 'datas/regular/multiple_hdus.fits', image_hdu=0,
...
# 10000's.
image_in_counts = im.load_ccd_data_from_fits(image_path=path + 'datas/image_in_counts/regular.fits', pixel_scale=0.1,
...
image_converted_to_eps = im.load_ccd_data_from_fits(image_path=path + 'datas/image_in_counts/regular.fits', pixel_scale=0.1,
                                                    noise_map_path=path+'datas/image_in_counts/noise_maps.fits',
                                                    psf_path=path+'datas/image_in_counts/psf.fits',
...
image_large_stamp = im.load_ccd_data_from_fits(image_path=path + 'datas/image_large_stamp/regular.fits', pixel_scale=0.1,
...
image_large_stamp_trimmed = im.load_ccd_data_from_fits(image_path=path + 'datas/image_large_stamp/regular.fits',
                                                       pixel_scale=0.1,
                                                       noise_map_path=path+'datas/image_large_stamp/noise_maps.fits',
                                                       psf_path=path+'datas/image_large_stamp/psf.fits',
...
# directions.
# image_offset_centre = im.load_imaging_from_fits(image_path=path+'datas/image_offset_centre/regular.fits', pixel_scale=0.1,
#                                   noise_map_path=path+'datas/image_offset_centre/noise_maps.fits',
#                                   psf_path=path+'datas/image_offset_centre/psf.fits')
...
# image_recentred_pixels = im.load_imaging_from_fits(image_path=path+'datas/image_small_stamp/regular.fits', pixel_scale=0.1,
#                                             noise_map_path=path+'datas/image_small_stamp/noise_maps.fits',
#                                             psf_path=path+'datas/image_small_stamp/psf.fits',
...
image_noise_from_wht = im.load_ccd_data_from_fits(image_path=path + 'datas/image_large_stamp/regular.fits',
                                                  pixel_scale=0.1,
                                                  noise_map_path=path+'datas/image_large_stamp/noise_maps.fits',
                                                  psf_path=path+'datas/image_large_stamp/psf.fits',
...
image_with_large_psf = im.load_ccd_data_from_fits(image_path=path + 'datas/image_with_large_psf/regular.fits',
                                                  pixel_scale=0.1,
...
image_with_trimmed_psf = im.load_ccd_data_from_fits(image_path=path + 'datas/image_with_large_psf/regular.fits',
                                                    pixel_scale=0.1,
                                                    noise_map_path=path+'datas/image_with_large_psf/noise_maps.fits',
                                                    psf_path=path+'datas/image_with_large_psf/psf.fits',
