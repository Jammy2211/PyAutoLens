...
# We'll start by learning about pixelizations, which are typically applied to the a source-plane. They're used to
# reconstruct the source galaxy - so lets first setup a lensed source-plane grid.
...
rectangular = pix.Rectangular(shape=(10, 10))
...
mapper_plotters.plot_rectangular_mapper(mapper=mapper, should_plot_centres=True)
...
# hopefully makes sense. Think about the following questions before moving on to the next tutorial:
