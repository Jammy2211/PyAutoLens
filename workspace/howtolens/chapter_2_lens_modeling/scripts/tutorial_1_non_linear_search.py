...
# random set of parameters. We could use this lens model to create a tracer and fit the image-datas, and quantify how
...
# To run the phase, we simply pass it the image datas we want to fit, and the non-linear search begins! As the phase
