    ...
    class TestSparsePixels(object):
        class TestSetupAll:
            ...
            def test__7x7_circle_mask__sparse_grid_size_3(self):
                ...
                assert (image_to_sparse == np.array(
...
class TestMask(object):
    class TestPixelScale(object):
        ...
        def test__shape(self):
            ...
            assert analysis_image.Mask.circular(arc_second_dimensions=(3, 3), pixel_scale=0.2, radius=5).shape == (
            15, 15)
    ...
    class TestAnnular(object):
        def test__odd_x_odd_mask_inner_radius_zero_outer_radius_small__mask(self):
            mask = analysis_image.Mask.annular(arc_second_dimensions=(3, 3), pixel_scale=1, inner_radius=0,
                                               outer_radius=0.5)
        ...
        def test__odd_x_odd_mask_inner_radius_small_outer_radius_large__mask(self):
            mask = analysis_image.Mask.annular(arc_second_dimensions=(3, 3), pixel_scale=1, inner_radius=0.5,
                                               outer_radius=3)
        ...
        def test__even_x_odd_mask_inner_radius_small_outer_radius_medium__mask(self):
            mask = analysis_image.Mask.annular(arc_second_dimensions=(4, 3), pixel_scale=1, inner_radius=0.51,
                                               outer_radius=1.51)
        ...
        def test__even_x_odd_mask_inner_radius_medium_outer_radius_large__mask(self):
            mask = analysis_image.Mask.annular(arc_second_dimensions=(4, 3), pixel_scale=1, inner_radius=1.51,
                                               outer_radius=3)
        ...
        def test__even_x_even_mask_inner_radius_small_outer_radius_medium__mask(self):
            mask = analysis_image.Mask.annular(arc_second_dimensions=(4, 4), pixel_scale=1, inner_radius=0.81,
                                               outer_radius=2)
        ...
        def test__even_x_even_mask_inner_radius_medium_outer_radius_large__mask(self):
            mask = analysis_image.Mask.annular(arc_second_dimensions=(4, 4), pixel_scale=1, inner_radius=1.71,
                                               outer_radius=3)
