...
class TestNumbering(object):
    def test_simple_numbering(self, simple_number_array):
        ...
        msk = mask.Mask(np.ones(shape))

        number_array = msk.number_array
    ...
    def test_simple_mask(self, cross_mask):
        number_array = mask.Mask(cross_mask).number_array
...
class TestComputeBlurringMask(object):
    ...
    def test__size__3x3_small_mask(self):
        ...
        blurring_mask = msk.compute_blurring_mask(psf_size=(3, 3))
