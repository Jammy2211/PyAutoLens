...
class TestEllipticalProfile(object):
    ...
    class TestRotateCoordinatesThenBackToCartesian(object):
        ...
        def test__include_offset_profile_centre__original_coordinates_shift_but_returned_coordinates_do_not_shift_back(self):
...
class TestSphericalProfile(object):
    ...
    class TestRotateCoordinatesAndThenBackToCartesian(object):
        ...
        def test_include_offset_profile_centre__original_coordinates_shift_but_returned_coordinates_do_not_shift_back(self):
