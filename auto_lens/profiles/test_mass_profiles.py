...
class TestConstructors(object):
    ...
    def test__setup_elliptical_nfw(self):
        ...
        nfw = mass_profiles.EllipticalNFWMassProfile(centre=(0.7, 1.0), axis_ratio=0.7, phi=60.0, kappa_s=2.0,
                                                     scale_radius=10.0)
    ...
    def test__setup_spherical_nfw(self):
        ...
        nfw = mass_profiles.SphericalNFWMassProfile(centre=(0.7, 1.0), kappa_s=2.0, scale_radius=10.0)
    ...
    def test__setup_exponential(self):
        ...
        exponential = mass_profiles.ExponentialMassProfile(centre=(0.0, 0.0), axis_ratio=1.0, phi=0.0, intensity=1.0,
    ...
    def test__setup_dev_vaucouleurs(self):
        ...
        dev_vaucouleurs = mass_profiles.DevVaucouleursMassProfile(centre=(0.0, 0.0), axis_ratio=1.0, phi=0.0, intensity=1.0,
                                                 effective_radius=0.6, mass_to_light_ratio=1.0)
...
class TestProfiles(object):
    ...
    class TestSphericalPowerLaw(object):
        class TestSurfaceDensity(object):
            def test__flip_coordinates_lens_center__same_value(self):
                isothermal = mass_profiles.SphericalPowerLawMassProfile(centre=(0.0, 0.0), einstein_radius=1.0,
                                                                        slope=2.0)

                surface_density_1 = isothermal.surface_density_at_coordinates(coordinates=(1.0, 1.0))

                isothermal = mass_profiles.SphericalPowerLawMassProfile(centre=(1.0, 1.0), einstein_radius=1.0,
                                                                        slope=2.0)
            ...
            def test__simple_case_2__correct_value(self):
                isothermal = mass_profiles.SphericalPowerLawMassProfile(centre=(0.0, 0.0), einstein_radius=2.0,
                                                                        slope=2.2)
        ...
        class TestPotential(object):
            ...
            def test__compare_to_fortran_values_high_slope__same_potential(self):
                isothermal = mass_profiles.SphericalPowerLawMassProfile(centre=(0.5, -0.7), einstein_radius=1.3,
                                                                        slope=2.3)
            ...
            def test__compare_to_elliptical_power_law__same_values(self):
                isothermal = mass_profiles.SphericalPowerLawMassProfile(centre=(0.8, -0.4), einstein_radius=3.0,
                                                                        slope=1.7)
            ...
            def test__compare_to_spherical_isothermal__same_values(self):
                ...
                power_law = mass_profiles.SphericalPowerLawMassProfile(centre=(0.2, -0.4), einstein_radius=3.0,
                                                                       slope=2.0)
        ...
        class TestDeflections(object):
            def test__compare_to_elliptical_power_law__same_value(self):
                ...
                isothermal = mass_profiles.SphericalPowerLawMassProfile(centre=(0.9, 0.5), einstein_radius=4.0,
                                                                        slope=2.3)
            ...
            def test__compare_to_elliptical_power_law_2__same_value(self):
                ...
                isothermal = mass_profiles.SphericalPowerLawMassProfile(centre=(0.1, -0.5), einstein_radius=2.0,
                                                                        slope=1.6)
            ...
            def test__compare_to_fortran_slope_isothermal__same_defls(self):
                power_law = mass_profiles.SphericalPowerLawMassProfile(centre=(0.2, 0.2), einstein_radius=1.0,
                                                                       slope=2.0)
    ...
    class TestCoredEllipticalPowerLaw(object):
        class TestSurfaceDensity(object):
            ...
            def test__function__same_as_power_law_no_core(self):
                power_law_core = mass_profiles.CoredEllipticalPowerLawMassProfile(centre=(1, 1), axis_ratio=1.0,
                                                                                  phi=45.0,
                                                                                  einstein_radius=1.0, slope=2.2,
                                                                                  core_radius=0.)
            ...
            def test__flip_coordinates_lens_center__same_value(self):
                ...
                power_law_core = mass_profiles.CoredEllipticalPowerLawMassProfile(centre=(1.0, 1.0), axis_ratio=1.0,
                                                                                  phi=0.0,
                                                                                  einstein_radius=1.0, slope=2.0,
                                                                                  core_radius=0.2)
            ...
            def test__different_axis_ratio__new_value(self):
                power_law_core = mass_profiles.CoredEllipticalPowerLawMassProfile(centre=(0.0, 0.0), axis_ratio=0.5,
                                                                                  phi=0.0,
                                                                                  einstein_radius=1.0, slope=2.0,
                                                                                  core_radius=0.2)
        ...
        class TestPotential(object):
            ...
            def test__value_via_fortran__same_value(self):
                power_law = mass_profiles.CoredEllipticalPowerLawMassProfile(centre=(0.5, -0.7), axis_ratio=0.7,
                                                                             phi=60.0,
                                                                             einstein_radius=1.3, slope=1.8,
                                                                             core_radius=0.2)
            ...
            def test__value_via_fortran_2__same_value(self):
                power_law = mass_profiles.CoredEllipticalPowerLawMassProfile(centre=(-0.2, 0.2), axis_ratio=0.6,
                                                                             phi=120.0,
    ...
    class TestCoredSphericalPowerLaw(object):
        class TestSurfaceDensity(object):
            def test__function__gives_correct_values(self):
                power_law = mass_profiles.CoredSphericalPowerLawMassProfile(centre=(1, 1), einstein_radius=1.0,
                                                                            slope=2.2,
                                                                            core_radius=0.1)
    ...
    class TestEllipticalIsothermal(object):
        ...
        class TestPotential(object):
            ...
            def test__compare_to_power_law__same_values(self):
                isothermal = mass_profiles.EllipticalIsothermalMassProfile(centre=(0.8, -0.4), axis_ratio=0.5,
                                                                           phi=170.0,
                                                                           einstein_radius=3.0)
    ...
    class TestSphericalIsothermal(object):
        ...
        class TestDeflections(object):
            def test__compare_to_elliptical_isothermal__same_value(self):
                isothermal = mass_profiles.EllipticalIsothermalMassProfile(centre=(0.9, 0.5), axis_ratio=0.99999,
                                                                           phi=0.0,
                                                                           einstein_radius=4.0)
    ...
    class TestCoredEllipticalIsothermal(object):
        class TestSurfaceDensity(object):
            def test__function__gives_correct_values(self):
                isothermal_core = mass_profiles.CoredEllipticalIsothermalMassProfile(centre=(1, 1), axis_ratio=1.0,
                                                                                     phi=45.0,
                                                                                     einstein_radius=1.0,
                                                                                     core_radius=0.1)
        ...
        class TestPotential(object):
            ...
            def test__rotation_90_ellpitical_cordinates_on_corners__same_value(self):
                ...
                isothermal = mass_profiles.CoredEllipticalIsothermalMassProfile(centre=(0.0, 0.0), axis_ratio=0.8,
                                                                                phi=90.0,
                                                                                einstein_radius=1.0, core_radius=0.2)
            ...
            def test__same_as_sie_for_no_core(self):
                isothermal_core = mass_profiles.CoredEllipticalIsothermalMassProfile(centre=(1, 1), axis_ratio=0.9,
                                                                                     phi=45.0,
                                                                                     einstein_radius=1.0,
                                                                                     core_radius=0.)
        ...
        class TestDeflections(object):
            ...
            def test__same_as_isothermal_core_for_core_0(self):
                ...
                isothermal_core = mass_profiles.EllipticalIsothermalMassProfile(centre=(0.3, -0.1), axis_ratio=0.7,
                                                                                phi=60.0,
                                                                                einstein_radius=1.1)
    ...
    class TestEllipticalGeneralizedNFWMassProfile(object):
        ...
        class TestDeflections(object):
            ...
            def test__compare_to_spherical_gnfw__same_values(self):
                gnfw = mass_profiles.EllipticalGeneralizedNFWMassProfile(centre=(1.0, 1.0), kappa_s=10.0,
                                                                         axis_ratio=1.0,
                                                                         phi=100.0, inner_slope=1.5, scale_radius=8.0)

                deflection_angle_1 = gnfw.deflection_angles_at_coordinates(coordinates=(3.0, 3.0))

                gnfw = mass_profiles.SphericalGeneralizedNFWMassProfile(centre=(1.0, 1.0), kappa_s=10.0,
                                                                        inner_slope=1.5,
                                                                        scale_radius=8.0)
            ...
            def test__compare_to_spherical_gnfw_2__same_values(self):
                gnfw = mass_profiles.EllipticalGeneralizedNFWMassProfile(centre=(-1.0, -2.0), kappa_s=1.0,
                                                                         axis_ratio=1.0,
                                                                         phi=100.0, inner_slope=0.5, scale_radius=3.0)

                deflection_angle_1 = gnfw.deflection_angles_at_coordinates(coordinates=(1.0, -3.0))

                gnfw = mass_profiles.SphericalGeneralizedNFWMassProfile(centre=(-1.0, -2.0), kappa_s=1.0,
                                                                        inner_slope=0.5,
                                                                        scale_radius=3.0)
            ...
            def test__compare_to_elliptical_nfw__same_values(self):
                gnfw = mass_profiles.EllipticalGeneralizedNFWMassProfile(centre=(-5.0, -10.0), kappa_s=0.1,
                                                                         axis_ratio=0.5,
    ...
    class TestSphericalGeneralizedNFWMassProfile(object):
        ...
        class TestDeflections(object):
            ...
            def test__compare_to_spherical_nfw_2__same_values(self):
                gnfw = mass_profiles.SphericalGeneralizedNFWMassProfile(centre=(-5.0, -10.0), kappa_s=0.1,
                                                                        inner_slope=1.0,
                                                                        scale_radius=20.0)
    ...
    class TestSersicMassProfile(object):
        ...
        class TestDeflections(object):
            ...
            def test__compare_to_dev_vaucauleurs__same_defls(self):
                ...
                sersic_defls = sersic.deflection_angles_at_coordinates(coordinates=(0.1625, 0.1625))

                dev_vaucouleurs = mass_profiles.DevVaucouleursMassProfile(centre=(0.2, 0.4), axis_ratio=0.9, phi=10.0,
                                                                          intensity=2.0,
                                                                          effective_radius=0.8, mass_to_light_ratio=3.0)

                dev_vaucouleurs_defls = dev_vaucouleurs.deflection_angles_at_coordinates(coordinates=(0.1625, 0.1625))
            ...
            def test__compare_to_exponential__same_defls(self):
                ...
                exponential = mass_profiles.ExponentialMassProfile(centre=(-0.2, -0.4), axis_ratio=0.8, phi=110.0,
                                                                   intensity=5.0,
                                                                   effective_radius=0.2, mass_to_light_ratio=1.0)

                exponential_defls = exponential.deflection_angles_at_coordinates(coordinates=(0.1625, 0.1625))
            ...
            def test__from_light_profile(self):
                light_sersic = mass_profiles.light_profiles.SersicLightProfile(centre=(-0.2, -0.4), axis_ratio=0.8,
                                                                               phi=110.0,
                                                                               intensity=5.0, effective_radius=0.2,
                                                                               sersic_index=2.0)
                mass_sersic = mass_profiles.SersicMassProfile.from_sersic_light_profile(light_sersic,
    ...
    class TestExponentialMassProfile(object):
        class TestSurfaceDensity(object):

            def test__flip_coordinates_lens_center__same_value(self):
                exponential = mass_profiles.ExponentialMassProfile(centre=(0.0, 0.0), axis_ratio=1.0, phi=0.0,
                                                                   intensity=1.0,
                                                                   effective_radius=1.0, mass_to_light_ratio=1.0)

                surface_density_1 = exponential.surface_density_at_coordinates(coordinates=(1.0, 1.0))

                exponential = mass_profiles.ExponentialMassProfile(centre=(1.0, 1.0), axis_ratio=1.0, phi=0.0,
                                                                   intensity=1.0,
                                                                   effective_radius=1.0, mass_to_light_ratio=1.0)

                surface_density_2 = exponential.surface_density_at_coordinates(coordinates=(0.0, 0.0))
            ...
            def test__rotation_coordinates_90_circular__same_value(self):
                ...
                surface_density_1 = exponential.surface_density_at_coordinates(coordinates=(1.0, 0.0))

                exponential = mass_profiles.ExponentialMassProfile(centre=(0.0, 0.0), axis_ratio=1.0, phi=90.0,
                                                                   intensity=1.0,
                                                                   effective_radius=1.0, mass_to_light_ratio=1.0)

                surface_density_2 = exponential.surface_density_at_coordinates(coordinates=(0.0, 1.0))

                assert surface_density_1 == surface_density_2

            def test__rotation_90_ellpitical_cordinates_on_corners__same_value(self):
                exponential = mass_profiles.ExponentialMassProfile(centre=(0.0, 0.0), axis_ratio=0.8, phi=0.0,
                                                                   intensity=1.0,
                                                                   effective_radius=1.0, mass_to_light_ratio=1.0)

                surface_density_1 = exponential.surface_density_at_coordinates(coordinates=(1.0, 0.0))

                exponential = mass_profiles.ExponentialMassProfile(centre=(0.0, 0.0), axis_ratio=0.8, phi=90.0,
                                                                   intensity=1.0,
                                                                   effective_radius=1.0, mass_to_light_ratio=1.0)
            ...
            def test__simple_case_1__correct_value(self):
                exponential = mass_profiles.ExponentialMassProfile(axis_ratio=0.5, phi=0.0, intensity=3.0,
                                                                   effective_radius=2.0, mass_to_light_ratio=1.0)

                surface_density = exponential.surface_density_at_coordinates(coordinates=(0.0, 1.0))

                assert surface_density == pytest.approx(4.9047, 1e-3)

            def test__simple_case_2__correct_value(self):
                exponential = mass_profiles.ExponentialMassProfile(axis_ratio=0.5, phi=90.0, intensity=2.0,
                                                                   effective_radius=3.0, mass_to_light_ratio=1.0)

                surface_density = exponential.surface_density_at_coordinates(coordinates=(1.0, 0.0))

                assert surface_density == pytest.approx(4.8566, 1e-3)

            def test__double_intensity__doubles_value(self):
                exponential = mass_profiles.ExponentialMassProfile(axis_ratio=0.5, phi=90.0, intensity=4.0,
                                                                   effective_radius=3.0, mass_to_light_ratio=1.0)
            ...
            def test__different_rotate_phi_90_same_result(self):
                ...
                surface_density_1 = exponential.surface_density_at_coordinates(coordinates=(0.0, 1.0))

                exponential = mass_profiles.ExponentialMassProfile(axis_ratio=0.5, phi=90.0, intensity=3.0,
                                                                   effective_radius=2.0, mass_to_light_ratio=1.0)

                surface_density_2 = exponential.surface_density_at_coordinates(coordinates=(1.0, 0.0))
        ...
        class TestDeflections(object):
            def test__flip_coordinates_lens_center__same_value(self):
                ...
                deflection_angle_1 = exponential.deflection_angles_at_coordinates(coordinates=(1.0, 1.0))

                exponential = mass_profiles.ExponentialMassProfile(centre=(1.0, 1.0), axis_ratio=1.0, phi=0.0,
                                                                   intensity=1.0,
                                                                   effective_radius=1.0, mass_to_light_ratio=1.0)

                deflection_angle_2 = exponential.deflection_angles_at_coordinates(coordinates=(0.0, 0.0))
            ...
            def test__rotation_coordinates_90_circular__same_value(self):
                ...
                deflection_angle_1 = exponential.deflection_angles_at_coordinates(coordinates=(1.0, 0.0))

                exponential = mass_profiles.ExponentialMassProfile(centre=(0.0, 0.0), axis_ratio=1.0, phi=90.0,
                                                                   intensity=1.0,
                                                                   effective_radius=1.0, mass_to_light_ratio=1.0)

                deflection_angle_2 = exponential.deflection_angles_at_coordinates(coordinates=(0.0, 1.0))
            ...
            def test__compare_to_fortran__same_defls(self):
                exponential = mass_profiles.ExponentialMassProfile(centre=(-0.2, -0.4), axis_ratio=0.8, phi=110.0,
                                                                   intensity=5.0,
                                                                   effective_radius=0.2, mass_to_light_ratio=1.0)

                defls = exponential.deflection_angles_at_coordinates(coordinates=(0.1625, 0.1625))
            ...
            def test__from_light_profile(self):
                light_exponential = mass_profiles.light_profiles.ExponentialLightProfile(
                    centre=(-0.2, -0.4), axis_ratio=0.8, phi=110.0, intensity=5.0, effective_radius=0.2)

                mass_exponential = mass_profiles.ExponentialMassProfile.from_exponential_light_profile(
                    light_exponential,
                    mass_to_light_ratio=1.)

                defls = mass_exponential.deflection_angles_at_coordinates(coordinates=(0.1625, 0.1625))

                assert defls[0] == pytest.approx(0.62569, 1e-3)
                assert defls[1] == pytest.approx(0.90493, 1e-3)


    class TestDevVaucouleursMassProfile(object):
        class TestSurfaceDensity(object):

            def test__flip_coordinates_lens_center__same_value(self):
                dev_vaucouleurs = mass_profiles.DevVaucouleursMassProfile(centre=(0.0, 0.0), axis_ratio=1.0, phi=0.0,
                                                                          intensity=1.0,
                                                                          effective_radius=1.0, mass_to_light_ratio=1.0)

                surface_density_1 = dev_vaucouleurs.surface_density_at_coordinates(coordinates=(1.0, 1.0))

                dev_vaucouleurs = mass_profiles.DevVaucouleursMassProfile(centre=(1.0, 1.0), axis_ratio=1.0, phi=0.0,
                                                                          intensity=1.0,
                                                                          effective_radius=1.0, mass_to_light_ratio=1.0)

                surface_density_2 = dev_vaucouleurs.surface_density_at_coordinates(coordinates=(0.0, 0.0))
            ...
            def test__rotation_coordinates_90_circular__same_value(self):
                ...
                surface_density_1 = dev_vaucouleurs.surface_density_at_coordinates(coordinates=(1.0, 0.0))

                dev_vaucouleurs = mass_profiles.DevVaucouleursMassProfile(centre=(0.0, 0.0), axis_ratio=1.0, phi=90.0,
                                                                          intensity=1.0,
                                                                          effective_radius=1.0, mass_to_light_ratio=1.0)

                surface_density_2 = dev_vaucouleurs.surface_density_at_coordinates(coordinates=(0.0, 1.0))

                assert surface_density_1 == surface_density_2

            def test__rotation_90_ellpitical_cordinates_on_corners__same_value(self):
                dev_vaucouleurs = mass_profiles.DevVaucouleursMassProfile(centre=(0.0, 0.0), axis_ratio=0.8, phi=0.0,
                                                                          intensity=1.0,
                                                                          effective_radius=1.0, mass_to_light_ratio=1.0)

                surface_density_1 = dev_vaucouleurs.surface_density_at_coordinates(coordinates=(1.0, 0.0))

                dev_vaucouleurs = mass_profiles.DevVaucouleursMassProfile(centre=(0.0, 0.0), axis_ratio=0.8, phi=90.0,
                                                                          intensity=1.0,
                                                                          effective_radius=1.0, mass_to_light_ratio=1.0)
            ...
            def test__simple_case_1__correct_value(self):
                dev_vaucouleurs = mass_profiles.DevVaucouleursMassProfile(axis_ratio=0.5, phi=0.0, intensity=3.0,
                                                                          effective_radius=2.0, mass_to_light_ratio=1.0)

                surface_density = dev_vaucouleurs.surface_density_at_coordinates(coordinates=(0.0, 1.0))

                assert surface_density == pytest.approx(5.6697, 1e-3)

            def test__simple_case_2__correct_value(self):
                dev_vaucouleurs = mass_profiles.DevVaucouleursMassProfile(axis_ratio=0.5, phi=90.0, intensity=2.0,
                                                                          effective_radius=3.0, mass_to_light_ratio=1.0)

                surface_density = dev_vaucouleurs.surface_density_at_coordinates(coordinates=(1.0, 0.0))

                assert surface_density == pytest.approx(7.4455, 1e-3)

            def test__double_intensity__doubles_value(self):
                dev_vaucouleurs = mass_profiles.DevVaucouleursMassProfile(axis_ratio=0.5, phi=90.0, intensity=4.0,
                                                                          effective_radius=3.0, mass_to_light_ratio=1.0)
            ...
            def test__different_rotate_phi_90_same_result(self):
                ...
                surface_density_1 = dev_vaucouleurs.surface_density_at_coordinates(coordinates=(0.0, 1.0))

                dev_vaucouleurs = mass_profiles.DevVaucouleursMassProfile(axis_ratio=0.5, phi=90.0, intensity=3.0,
                                                                          effective_radius=2.0, mass_to_light_ratio=1.0)

                surface_density_2 = dev_vaucouleurs.surface_density_at_coordinates(coordinates=(1.0, 0.0))
        ...
        class TestDeflections(object):
            ...
            def test__flip_coordinates_lens_center__same_value(self):
                ...
                deflection_angle_1 = dev_vaucouleurs.deflection_angles_at_coordinates(coordinates=(1.0, 1.0))

                dev_vaucouleurs = mass_profiles.DevVaucouleursMassProfile(centre=(1.0, 1.0), axis_ratio=1.0, phi=0.0,
                                                                          intensity=1.0,
                                                                          effective_radius=1.0, mass_to_light_ratio=1.0)

                deflection_angle_2 = dev_vaucouleurs.deflection_angles_at_coordinates(coordinates=(0.0, 0.0))
            ...
            def test__rotation_coordinates_90_circular__same_value(self):
                ...
                deflection_angle_1 = dev_vaucouleurs.deflection_angles_at_coordinates(coordinates=(1.0, 0.0))

                dev_vaucouleurs = mass_profiles.DevVaucouleursMassProfile(centre=(0.0, 0.0), axis_ratio=1.0, phi=90.0,
                                                                          intensity=1.0,
                                                                          effective_radius=1.0, mass_to_light_ratio=1.0)

                deflection_angle_2 = dev_vaucouleurs.deflection_angles_at_coordinates(coordinates=(0.0, 1.0))
            ...
            def test__compare_to_fortran__same_defls(self):
                ...
                defls = dev_vaucouleurs.deflection_angles_at_coordinates(coordinates=(0.1625, 0.1625))
            ...
            def test__from_light_profile(self):
                light_dev_vaucouleurs = mass_profiles.light_profiles.DevVaucouleursLightProfile(
                    centre=(0.2, 0.4), axis_ratio=0.9, phi=10.0, intensity=2.0, effective_radius=0.8)

                mass_dev_vaucouleurs = mass_profiles.DevVaucouleursMassProfile.from_dev_vaucouleurs_light_profile(
                    light_dev_vaucouleurs,
                    mass_to_light_ratio=3.)

                defls = mass_dev_vaucouleurs.deflection_angles_at_coordinates(coordinates=(0.1625, 0.1625))
