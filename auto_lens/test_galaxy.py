...
class TestLightProfiles(object):
    ...
    class TestIntensity:
        ...
        def test__one_profile_galaxy__intensity_is_same_individual_profile(self):
            ...
            sersic_intensity = sersic.intensity_at_coordinates((1.05, -0.55))
            ...
            galaxy_sersic_intensity = galaxy_sersic.intensity_at_coordinates((1.05, -0.55))
        ...
        def test__two_profile_galaxy__intensity_is_sum_of_individual_profiles(self):
            ...
            intensity = sersic_1.intensity_at_coordinates((1.05, -0.55))
            intensity += sersic_2.intensity_at_coordinates((1.05, -0.55))
        ...
        def test__three_profile_galaxy__intensity_is_sum_of_individual_profiles(self):
            ...
            intensity = sersic_1.intensity_at_coordinates((1.05, -0.55))
            intensity += sersic_2.intensity_at_coordinates((1.05, -0.55))
            intensity += sersic_3.intensity_at_coordinates((1.05, -0.55))
        ...
        def test__three_profile_galaxy__individual_intensities_can_be_extracted(self):
            ...
            intensity_1 = sersic_1.intensity_at_coordinates((1.05, -0.55))
            intensity_2 = sersic_2.intensity_at_coordinates((1.05, -0.55))
            intensity_3 = sersic_3.intensity_at_coordinates((1.05, -0.55))
    ...
    class TestSymmetricProfiles(object):
        ...
        def test_1d_symmetry(self):
            ...
            assert galaxy_sersic.intensity_at_coordinates((0, 0)) == galaxy_sersic.intensity_at_coordinates((100, 0))
            assert galaxy_sersic.intensity_at_coordinates((49, 0)) == galaxy_sersic.intensity_at_coordinates((51, 0))
        ...
        def test_2d_symmetry(self):
            ...
            assert galaxy_sersic.intensity_at_coordinates((49, 0)) == \
                   pytest.approx(galaxy_sersic.intensity_at_coordinates((51, 0)), 1e-5)

            assert galaxy_sersic.intensity_at_coordinates((0, 49)) == \
                   pytest.approx(galaxy_sersic.intensity_at_coordinates((0, 51)), 1e-5)

            assert galaxy_sersic.intensity_at_coordinates((100, 49)) == \
                   pytest.approx(galaxy_sersic.intensity_at_coordinates((100, 51)), 1e-5)

            assert galaxy_sersic.intensity_at_coordinates((49, 49)) == \
                   pytest.approx(galaxy_sersic.intensity_at_coordinates((51, 51)), 1e-5)
...
class TestMassProfiles(object):
    ...
    class TestSurfaceDensity:
        ...
        def test__one_profile_galaxy__surface_density_is_same_individual_profile(self):
            ...
            sie_surface_density = sie.surface_density_at_coordinates((1.05, -0.55))
            ...
            galaxy_sie_surface_density = galaxy_sie.surface_density_at_coordinates((1.05, -0.55))
        ...
        def test__two_profile_galaxy__surface_density_is_sum_of_individual_profiles(self):
            ...
            surface_density = sie_1.surface_density_at_coordinates((1.05, -0.55))
            surface_density += sie_2.surface_density_at_coordinates((1.05, -0.55))

            galaxy_sie = galaxy.Galaxy(redshift=0.5, mass_profiles=[
                mass_profiles.EllipticalIsothermalMassProfile(axis_ratio=0.8, phi=10.0, einstein_radius=1.0),
                mass_profiles.EllipticalIsothermalMassProfile(axis_ratio=0.6, phi=30.0, einstein_radius=1.2)])

            galaxy_surface_density = galaxy_sie.surface_density_at_coordinates((1.05, -0.55))
        ...
        def test__three_profile_galaxy__surface_density_is_sum_of_individual_profiles(self):
            ...
            surface_density = sie_1.surface_density_at_coordinates((1.05, -0.55))
            surface_density += sie_2.surface_density_at_coordinates((1.05, -0.55))
            surface_density += sie_3.surface_density_at_coordinates((1.05, -0.55))
        ...
        def test__three_profile_galaxy__individual_surface_densities_can_be_extracted(self):
            ...
            surface_density_1 = sie_1.surface_density_at_coordinates((1.05, -0.55))
            surface_density_2 = sie_2.surface_density_at_coordinates((1.05, -0.55))
            surface_density_3 = sie_3.surface_density_at_coordinates((1.05, -0.55))
    ...
    class TestPotential:
        ...
        def test__one_profile_galaxy__potential_is_same_individual_profile(self):
            ...
            sie_potential = sie.potential_at_coordinates((1.05, -0.55))

            galaxy_sie = galaxy.Galaxy(redshift=0.5, mass_profiles=[
                mass_profiles.EllipticalIsothermalMassProfile(axis_ratio=0.8, phi=10.0, einstein_radius=1.0)])

            galaxy_sie_potential = galaxy_sie.potential_at_coordinates((1.05, -0.55))
        ...
        def test__two_profile_galaxy__potential_is_sum_of_individual_profiles(self):
            ...
            potential = sie_1.potential_at_coordinates((1.05, -0.55))
            potential += sie_2.potential_at_coordinates((1.05, -0.55))

            galaxy_sie = galaxy.Galaxy(redshift=0.5, mass_profiles=[
                mass_profiles.EllipticalIsothermalMassProfile(axis_ratio=0.8, phi=10.0, einstein_radius=1.0),
                mass_profiles.EllipticalIsothermalMassProfile(axis_ratio=0.6, phi=30.0, einstein_radius=1.2)])

            galaxy_potential = galaxy_sie.potential_at_coordinates((1.05, -0.55))
        ...
        def test__three_profile_galaxy__potential_is_sum_of_individual_profiles(self):
            ...
            potential = sie_1.potential_at_coordinates((1.05, -0.55))
            potential += sie_2.potential_at_coordinates((1.05, -0.55))
            potential += sie_3.potential_at_coordinates((1.05, -0.55))
        ...
        def test__three_profile_galaxy__individual_potentials_can_be_extracted(self):
            ...
            potential_1 = sie_1.potential_at_coordinates((1.05, -0.55))
            potential_2 = sie_2.potential_at_coordinates((1.05, -0.55))
            potential_3 = sie_3.potential_at_coordinates((1.05, -0.55))
    ...
    class TestDeflectionAngles:
        ...
        def test__one_profile_galaxy__deflection_angles_is_same_individual_profile(self):
            ...
            sie_deflection_angles = sie.deflection_angles_at_coordinates((1.05, -0.55))

            galaxy_sie = galaxy.Galaxy(redshift=0.5, mass_profiles=[
                mass_profiles.EllipticalIsothermalMassProfile(axis_ratio=0.8, phi=10.0, einstein_radius=1.0)])

            galaxy_sie_deflection_angles = galaxy_sie.deflection_angles_at_coordinates((1.05, -0.55))
        ...
        def test__two_profile_galaxy__deflection_angles_is_sum_of_individual_profiles(self):
            ...
            deflection_angles_1 = sie_1.deflection_angles_at_coordinates((1.05, -0.55))
            deflection_angles_2 = sie_2.deflection_angles_at_coordinates((1.05, -0.55))
            ...
            galaxy_deflection_angles = galaxy_sie.deflection_angles_at_coordinates((1.05, -0.55))
        ...
        def test__three_profile_galaxy__deflection_angles_is_sum_of_individual_profiles(self):
            ...
            deflection_angles_1 = sie_1.deflection_angles_at_coordinates((1.05, -0.55))
            deflection_angles_2 = sie_2.deflection_angles_at_coordinates((1.05, -0.55))
            deflection_angles_3 = sie_3.deflection_angles_at_coordinates((1.05, -0.55))
        ...
        def test__three_profile_galaxy__individual_deflection_angles_can_be_extracted(self):
            ...
            galaxy_deflection_angles = galaxy_sie.deflection_angles_at_coordinates_individual((1.05, -0.55))

            assert deflection_angles_1 == galaxy_deflection_angles[0]
    ...
    class TestSymmetricProfiles:
        ...
        def test_1d_symmetry(self):
            ...
            assert galaxy_isothermal.surface_density_at_coordinates((1, 0)) == \
                   galaxy_isothermal.surface_density_at_coordinates((99, 0))

            assert galaxy_isothermal.surface_density_at_coordinates((49, 0)) == \
                   galaxy_isothermal.surface_density_at_coordinates((51, 0))
            
            assert galaxy_isothermal.potential_at_coordinates((1, 0)) == \
                   pytest.approx(galaxy_isothermal.potential_at_coordinates((99, 0)), 1e-6)

            assert galaxy_isothermal.potential_at_coordinates((49, 0)) == \
                   pytest.approx(galaxy_isothermal.potential_at_coordinates((51, 0)), 1e-6)

            assert galaxy_isothermal.deflection_angles_at_coordinates((1, 0)) == \
                   pytest.approx(galaxy_isothermal.deflection_angles_at_coordinates((99, 0)), 1e-6)

            assert galaxy_isothermal.deflection_angles_at_coordinates((49, 0)) == \
                   pytest.approx(galaxy_isothermal.deflection_angles_at_coordinates((51, 0)), 1e-6)
        ...
        def test_2d_symmetry(self):
            ...
            assert galaxy_isothermal.surface_density_at_coordinates((49, 0)) == pytest.approx(
                galaxy_isothermal.surface_density_at_coordinates((51, 0)), 1e-5)
            
            assert galaxy_isothermal.surface_density_at_coordinates((0, 49)) == pytest.approx(
                galaxy_isothermal.surface_density_at_coordinates((0, 51)), 1e-5)
            
            assert galaxy_isothermal.surface_density_at_coordinates((100, 49)) == pytest.approx(
                galaxy_isothermal.surface_density_at_coordinates((100, 51)), 1e-5)
            
            assert galaxy_isothermal.surface_density_at_coordinates((49, 49)) == pytest.approx(
                galaxy_isothermal.surface_density_at_coordinates((51, 51)), 1e-5)


            assert galaxy_isothermal.potential_at_coordinates((49, 0)) == pytest.approx(
                galaxy_isothermal.potential_at_coordinates((51, 0)), 1e-5)

            assert galaxy_isothermal.potential_at_coordinates((0, 49)) == pytest.approx(
                galaxy_isothermal.potential_at_coordinates((0, 51)), 1e-5)

            assert galaxy_isothermal.potential_at_coordinates((100, 49)) == pytest.approx(
                galaxy_isothermal.potential_at_coordinates((100, 51)), 1e-5)

            assert galaxy_isothermal.potential_at_coordinates((49, 49)) == pytest.approx(
                galaxy_isothermal.potential_at_coordinates((51, 51)), 1e-5)


            assert -1.0*galaxy_isothermal.deflection_angles_at_coordinates((49, 0))[0] == pytest.approx(
                galaxy_isothermal.deflection_angles_at_coordinates((51, 0))[0], 1e-5)

            assert 1.0*galaxy_isothermal.deflection_angles_at_coordinates((0, 49))[0] == pytest.approx(
                galaxy_isothermal.deflection_angles_at_coordinates((0, 51))[0], 1e-5)

            assert 1.0*galaxy_isothermal.deflection_angles_at_coordinates((100, 49))[0] == pytest.approx(
                galaxy_isothermal.deflection_angles_at_coordinates((100, 51))[0], 1e-5)

            assert -1.0*galaxy_isothermal.deflection_angles_at_coordinates((49, 49))[0] == pytest.approx(
                galaxy_isothermal.deflection_angles_at_coordinates((51, 51))[0], 1e-5)

            assert 1.0*galaxy_isothermal.deflection_angles_at_coordinates((49, 0))[1] == pytest.approx(
                galaxy_isothermal.deflection_angles_at_coordinates((51, 0))[1], 1e-5)

            assert -1.0*galaxy_isothermal.deflection_angles_at_coordinates((0, 49))[1] == pytest.approx(
                galaxy_isothermal.deflection_angles_at_coordinates((0, 51))[1], 1e-5)

            assert -1.0*galaxy_isothermal.deflection_angles_at_coordinates((100, 49))[1] == pytest.approx(
                galaxy_isothermal.deflection_angles_at_coordinates((100, 51))[1], 1e-5)

            assert -1.0*galaxy_isothermal.deflection_angles_at_coordinates((49, 49))[1] == pytest.approx(
                galaxy_isothermal.deflection_angles_at_coordinates((51, 51))[1], 1e-5)