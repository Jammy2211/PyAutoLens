...
def sub_coordinates_to_source_pixels_via_sparse_pairs(sub_coordinates, image_total, sub_total, source_centers,
    ...
    """ Match a set of sub_grid image_grid-pixel image_grid to their closest source-pixel, using the source-pixel centers (x,y).
        ...
        pairings and the source-image_to_pixel neighbors to speed up the function. This is optimal when the number of sub_grid \
        image_grid-image_to_pixel or source-image_to_pixel is large. Thus, the sparse_grid grid_coords of sub_grid must have had a source \
