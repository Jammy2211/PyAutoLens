...
class TestCase:
    def test_integration(self):
        ...
        source_galaxy_prior = gp.GalaxyPrior("source_galaxy", mapper,
        ...
        lens_galaxy_prior = gp.GalaxyPrior("lens_galaxy", mapper, light_profile=light_profiles.EllipticalExponential,
        ...
        instance = mapper.from_prior_medians()
