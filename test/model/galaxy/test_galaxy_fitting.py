...
class TestGalaxyFit:
    ...
    class TestCompareToManual:
        ...
        def test__intensities(self):
            ...
            residuals = fitting_util.residual_from_data_and_model_data([g_data[:]], model_datas)
            chi_squareds = fitting_util.chi_squared_from_residual_and_noise_map(residuals, [g_data.noise_map_])
            ...
            noise_terms = fitting_util.noise_term_from_noise_map([g_data.noise_map_])
        ...
        def test__deflections(self):
            ...
            residuals = fitting_util.residual_from_data_and_model_data([g_data_y[:], g_data_x[:]], model_datas)
            chi_squareds = fitting_util.chi_squared_from_residual_and_noise_map(residuals, [g_data_y.noise_map_,
                                                                                            g_data_x.noise_map_])
            ...
            chi_squared_terms = fitting_util.chi_squared_term_from_chi_squared(chi_squareds)
            noise_terms = fitting_util.noise_term_from_noise_map([g_data_y.noise_map_, g_data_x.noise_map_])
            likelihoods = fitting_util.likelihood_from_chi_squared_term_and_noise_term(chi_squared_terms, noise_terms)
