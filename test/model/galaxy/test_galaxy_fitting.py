...
class TestGalaxyFit:
    ...
    class TestCompareToManual:
        ...
        def test__intensities(self):
            ...
            chi_squareds = fitting_util.chi_squared_from_residuals_and_noise_map(residuals, [g_data.noise_map_])
        ...
        def test__deflections(self):
            ...
            chi_squareds = fitting_util.chi_squared_from_residuals_and_noise_map(residuals, [g_data_y.noise_map_,
                                                                                             g_data_x.noise_map_])
