...
class TestGalaxyFit:
    ...
    class TestCompareToManual:
        ...
        def test__intensities(self):
            ...
            chi_squareds = fitting_util.chi_squared_map_from_residual_map_mask_and_noise_map(residuals, [g_data.noise_map_])
            ...
            noise_terms = fitting_util.noise_normalization_from_mask_and_noise_map([g_data.noise_map_])
        ...
        def test__deflections(self):
            ...
            chi_squareds = fitting_util.chi_squared_map_from_residual_map_mask_and_noise_map(residuals, [g_data_y.noise_map_,
                                                                                                         g_data_x.noise_map_])
            ...
            chi_squared_terms = fitting_util.chi_squared_from_chi_squared_map(chi_squareds)
            noise_terms = fitting_util.noise_normalization_from_mask_and_noise_map([g_data_y.noise_map_, g_data_x.noise_map_])
            likelihoods = fitting_util.likelihood_from_chi_squared_and_noise_normalization(chi_squared_terms, noise_terms)
