...
def simulate_image_from_galaxies_and_output_to_fits(data_type, data_name, sub_grid_size, lens_galaxies,
                                                    source_galaxies, psf_shape=(51, 51), exposure_time=300.0,
                                                    background_sky_level=0.1):

    pixel_scale = simulation_util.pixel_scale_from_data_type(data_type=data_type)
    shape = simulation_util.shape_from_data_type(data_type=data_type)
...
def make_lens_only_dev_vaucouleurs(data_types, sub_grid_size):
    ...
    for data_type in data_types:
        ...
        simulate_image_from_galaxies_and_output_to_fits(data_type=data_type, data_name='lens_only_dev_vaucouleurs',
                                                        sub_grid_size=sub_grid_size, lens_galaxies=[lens_galaxy],
                                                        source_galaxies=[g.Galaxy()])

def make_lens_only_bulge_and_disk(data_types, sub_grid_size):
    ...
    for data_type in data_types:
        ...
        simulate_image_from_galaxies_and_output_to_fits(data_type=data_type, data_name='lens_only_bulge_and_disk',
                                                        sub_grid_size=sub_grid_size, lens_galaxies=[lens_galaxy],
                                                        source_galaxies=[g.Galaxy()])
...
def make_lens_only_x2_galaxies(data_types, sub_grid_size):
    ...
    for data_type in data_types:
        ...
        simulate_image_from_galaxies_and_output_to_fits(data_type=data_type, data_name='lens_only_x2_galaxies',
                                                        sub_grid_size=sub_grid_size,
                                                        lens_galaxies=[lens_galaxy_0, lens_galaxy_1],
                                                        source_galaxies=[g.Galaxy()])

def make_no_lens_light_and_source_smooth(data_types, sub_grid_size):
    ...
    for data_type in data_types:
        ...
        simulate_image_from_galaxies_and_output_to_fits(data_type=data_type, data_name='no_lens_light_and_source_smooth',
                                                        sub_grid_size=sub_grid_size,
...
def make_lens_and_source_cuspy(data_types, sub_grid_size):
    ...
    for data_type in data_types:
        ...
        simulate_image_from_galaxies_and_output_to_fits(data_type=data_type, data_name='lens_and_source_cuspy',
                                                        sub_grid_size=sub_grid_size,
                                                        lens_galaxies=[lens_galaxy], source_galaxies=[source_galaxy])