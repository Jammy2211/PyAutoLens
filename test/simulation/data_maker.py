...
makers.make_lens_only_dev_vaucouleurs(data_types=['LSST', 'Euclid'], sub_grid_size=16)
makers.make_lens_only_bulge_and_disk(data_types=['LSST', 'Euclid'], sub_grid_size=16)
makers.make_lens_only_x2_galaxies(data_types=['LSST', 'Euclid'], sub_grid_size=16)
makers.make_no_lens_light_and_source_smooth(data_types=['LSST', 'Euclid', 'HST', 'HST_Up', 'AO'], sub_grid_size=16)
makers.make_no_lens_light_and_source_cuspy(data_types=['LSST', 'Euclid', 'HST', 'HST_Up', 'AO'], sub_grid_size=16)
makers.make_lens_and_source_smooth(data_types=['LSST', 'Euclid', 'HST', 'HST_Up', 'AO'], sub_grid_size=16)
makers.make_lens_and_source_cuspy(data_types=['LSST', 'Euclid', 'HST', 'HST_Up', 'AO'], sub_grid_size=16)