...
class TestEllipticalProfile(object):
    ...
    class TestAnglesFromXAxis(object):
        ...
        def test__profile_angle_phi_is_0__cosine_and_sin_of_phi_is_1_and_0(self):
            elliptical_profile = geometry_profiles.EllipticalProfileGP(centre=(1, 1), axis_ratio=1.0, phi=0.0)
        ...
        def test__profile_angle_phi_is_45__cosine_and_sin_of_phi_follow_trig__therefore_half_root_2(self):
            elliptical_profile = geometry_profiles.EllipticalProfileGP(centre=(1, 1), axis_ratio=1.0, phi=45.0)
        ...
        def test__profile_angle_phi_is_60__cosine_and_sin_of_phi_follow_trig(self):
            elliptical_profile = geometry_profiles.EllipticalProfileGP(centre=(1, 1), axis_ratio=1.0, phi=60.0)
        ...
        def test__profile_angle_phi_is_225__cosine_and_sin_of_phi_follow_trig__therefore_negative_half_root_2(self):
            elliptical_profile = geometry_profiles.EllipticalProfileGP(centre=(1, 1), axis_ratio=1.0, phi=225.0)
    ...
    class TestTransformToEllipticalReferenceFrame(object):
        ...
        def test__profile_angle_phi_is_0__grid_x_1_y_1__returns_same_grid_so_x_1_y_1(self):
            ...
            elliptical_profile = geometry_profiles.EllipticalProfileGP(axis_ratio=1.0, phi=0.0)
        ...
        def test__profile_angle_phi_90__grid_x_1_y_1__rotated_grid_clockwise_so_x_1_y_negative_1(self):
            ...
            elliptical_profile = geometry_profiles.EllipticalProfileGP(axis_ratio=1.0, phi=90.0)
        ...
        def test__profile_angle_phi_180__grid_x_1_y_1__rotated_grid_clockwise_so_x_and_y_negative_1(self):
            elliptical_profile = geometry_profiles.EllipticalProfileGP(axis_ratio=1.0, phi=180.0)
        ...
        def test__profile_angle_phi_270__grid_x_1_y_1__rotated_grid_clockwise_so_x_negative_1_y_1(self):
            ...
            elliptical_profile = geometry_profiles.EllipticalProfileGP(axis_ratio=1.0, phi=270.0)
        ...
        def test__profile_angle_phi_360__rotated_grid_are_original_grid_x_1_y_(self):
            ...
            elliptical_profile = geometry_profiles.EllipticalProfileGP(axis_ratio=1.0, phi=360.0)
        ...
        def test__profile_angle_phi_315__grid_x_1_y_1__rotated_grid_clockwise_so_x_0_y_root_2(self):
            ...
            elliptical_profile = geometry_profiles.EllipticalProfileGP(axis_ratio=1.0, phi=315.0)
        ...
        def test__include_profile_centre_offset__is_used_before_rotation_is_performed(self):
            ...
            elliptical_profile = geometry_profiles.EllipticalProfileGP(axis_ratio=1.0, phi=90.0, centre=(2.0, 3.0))
    ...
    class TestTransformCoordinatesBackToCartesian(object):
        ...
        def test___profile_angle_phi_45__grid_x_1_y_1__rotated_counter_clockwise_to_x_0_y_root_2(self):
            ...
            elliptical_profile = geometry_profiles.EllipticalProfileGP(axis_ratio=1.0, phi=45.0)
    ...
    class TestCoordinateMovements(object):
        ...
        def test__grid_and_centres_of_two_lenses_are_equivalent__grid_are_equivalent(self):
            ...
            elliptical_profile1 = geometry_profiles.EllipticalProfileGP(axis_ratio=1.0, phi=0.0, centre=(0, 0))
            grid1 = np.array([[1.0, 1.0]])
            grid1 = elliptical_profile1.transform_grid_to_reference_frame(grid1)

            elliptical_profile2 = geometry_profiles.EllipticalProfileGP(axis_ratio=1.0, phi=0.0, centre=(-1, -1))
        ...
        def test__same_as_above_but_include_angle_phi_as_55__grid_are_equivalent(self):
            elliptical_profile1 = geometry_profiles.EllipticalProfileGP(axis_ratio=1.0, phi=55.0, centre=(0, 0))
            grid1 = np.array([[1.0, 1.0]])
            grid1 = elliptical_profile1.transform_grid_to_reference_frame(grid1)

            elliptical_profile2 = geometry_profiles.EllipticalProfileGP(axis_ratio=1.0, phi=55.0, centre=(-1, -1))
            grid2 = np.array([[0.0, 0.0]])
            grid2 = elliptical_profile2.transform_grid_to_reference_frame(grid2)
        ...
        def test__grid_are_again_the_same_after_centre_shift__grid_equivalent(self):
            elliptical_profile1 = geometry_profiles.EllipticalProfileGP(axis_ratio=1.0, phi=55.0, centre=(1, 1))
            grid1 = np.array([[1.0, 1.0]])
            grid1 = elliptical_profile1.transform_grid_to_reference_frame(grid1)
    ...
    class TestRotateCoordinatesThenBackToCartesian(object):
        ...
        def test__same_as_above_different_values(self):
            ...
            elliptical_profile = geometry_profiles.EllipticalProfileGP(axis_ratio=1.0, phi=160.232)
        ...
        def test__same_again_another_set_of_values(self):
            elliptical_profile = geometry_profiles.EllipticalProfileGP(axis_ratio=1.0, phi=174.342)
    ...
    class TestTransformedGridToEccentricRadius(object):
        ...
        def test__same_as_above_but_axis_ratio_is_05__r_follows_elliptical_coordinate_equation(self):
            ...
            elliptical_profile = geometry_profiles.EllipticalProfileGP(axis_ratio=0.5, phi=0.0)
...
class TestSphericalProfile(object):
    ...
    class TestCoordinatesMovement(object):
        ...
        def test__profile_cenre_x_0_y_0__grid_x_1_y_1__no_coordinate_movement_so_x_1_y_1(self):
            ...
            spherical_profile = geometry_profiles.SphericalProfileGP(centre=(0.0, 0.0))
        ...
        def test__grid_and_centres_of_two_lenses_are_equivalent__grid_are_equivalent(self):
            ...
            spherical_profile1 = geometry_profiles.SphericalProfileGP(centre=(0, 0))

            grid1 = np.array([[1.0, 1.0]])
            grid1 = spherical_profile1.transform_grid_to_reference_frame(grid1)

            spherical_profile2 = geometry_profiles.SphericalProfileGP(centre=(-1, -1))
            grid2 = np.array([[0.0, 0.0]])
        ...
        def test__grid_are_again_the_same_after_centre_shift__grid_equivalent(self):
            ...
            spherical_profile1 = geometry_profiles.SphericalProfileGP(centre=(1, 1))
            grid1 = np.array([[1.0, 1.0]])
            grid1 = spherical_profile1.transform_grid_to_reference_frame(grid1)
...
#         p = geometry_profiles.EllipticalProfileGP((3, 5), 2, 2)
...
class TestFromProfile(object):
    ...
    def test__elliptical_profile_from_profile__centre_x_1_y_1__axis_ratio_1__phi_2__all_are_passed(self):
        p = geometry_profiles.GeometryProfile(centre=(1, 1))
        elliptical_profile = geometry_profiles.EllipticalProfileGP.from_profile(p, axis_ratio=1, phi=2)
        assert elliptical_profile.__class__ == geometry_profiles.EllipticalProfileGP
    ...
    def test__profile_from_elliptical_profile__centre_x_1_y_1_is_passed(self):
        elliptical_profile = geometry_profiles.EllipticalProfileGP(centre=(1, 1), axis_ratio=1, phi=2)
    ...
    def test__elliptcal_profile_from_elliptical_profile__optionally_override_axis_ratio_with_3(self):
        elliptical_profile = geometry_profiles.EllipticalProfileGP(axis_ratio=1, phi=2)
        new_geometry_profile = geometry_profiles.EllipticalProfileGP.from_profile(elliptical_profile, axis_ratio=3)
