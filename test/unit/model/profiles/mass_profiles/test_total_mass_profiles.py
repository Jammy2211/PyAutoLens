...
class TestCoredPowerLaw(object):
    ...
    def test__summarize_in_units(self):
        ...
        i += 1
        assert summary_text[i] == 'pl_einstein_radius                                1.00 arcsec';
        i += 1
        assert summary_text[i] == 'pl_einstein_mass                                  3.1416e+00 angular';
        i += 1
        assert summary_text[i] == 'pl_mass_within_10.00_arcsec                       3.1416e+01 angular';
        i += 1
        assert summary_text[i] == 'pl_mass_within_500.00_arcsec                      1.5708e+03 angular';
        i += 1
