...
class TestGaussian:
    ...
    def test__intensity_from_grid__same_values_as_above(self):
        ...
        assert gaussian.image_from_grid(
    ...
    def test__spherical_and_elliptical_match(self):
        ...
        assert (
            elliptical.image_from_grid(grid)
            == spherical.image_from_grid(grid)
        ).all()
...
class TestDevVaucouleurs:
    ...
    def test__intensity_at_radius__correct_value(self):
        ...
        assert dev_vaucouleurs.image_from_grid_radii(
            grid_radii=1.0
