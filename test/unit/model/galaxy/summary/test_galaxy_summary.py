...
class TestSummarizeGalaxy:
    ...
    def test__summarize_galaxy_with_nfw_mass_profile(self):
        ...
        assert summary_text[0] == 'Galaxy = lol \n'
        assert summary_text[1] == '\n'
        assert summary_text[2] == 'Mass Profile = MockTruncatedNFW \n'
        assert summary_text[3] == '\n'
        assert summary_text[4] == 'Einstein Radius = 10.00" \n'
        assert summary_text[5] == 'Mass within Einstein Radius = 1.0000e+03 solMass \n'
        assert summary_text[6] == 'Mass within 10.00" = 1.0000e+03 solMass \n'
        assert summary_text[7] == 'Mass within 500.00" = 1.0000e+03 solMass \n'
        assert summary_text[8] == 'Rho at scale radius = 100.00 \n'
        assert summary_text[9] == 'Delta concentration = 200.00 \n'
        assert summary_text[10] == 'Concentration = 300.00 \n'
        assert summary_text[11] == 'Radius at 200x cosmic average density = 400.00" \n'
        assert summary_text[12] == 'Mass at 200x cosmic average density = 500.00 solMass \n'
        assert summary_text[13] == 'Mass at truncation radius = 600.00 solMass \n'
