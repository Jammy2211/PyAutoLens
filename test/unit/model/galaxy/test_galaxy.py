...
class TestLightProfiles(object):
    class TestIntensity:
        ...
        def test__galaxies_with_x1_and_x2_light_profiles__profile_image_is_same_individual_profiles(
            ...
            lp_profile_image = lp_0.profile_image_from_grid(
                grid=np.array([[1.05, -0.55]]), return_in_2d=False, return_binned=False
            )
    ...
    class TestLuminosityWithin:
        ...
        def test__no_light_profile__returns_none(self):
            gal_no_lp = al.Galaxy(redshift=0.5, mass=al.mass_profiles.SphericalIsothermal())
    ...
    class TestSymmetricProfiles(object):
        def test_1d_symmetry(self):
            ...
            assert gal_x2_lp.profile_image_from_grid(
                np.array([[0.0, 0.0]]), return_in_2d=False, return_binned=False
            ) == gal_x2_lp.profile_image_from_grid(
                grid=np.array([[100.0, 0.0]]), return_in_2d=False, return_binned=False
            )
            assert gal_x2_lp.profile_image_from_grid(
                np.array([[49.0, 0.0]]), return_in_2d=False, return_binned=False
            ) == gal_x2_lp.profile_image_from_grid(
                grid=np.array([[51.0, 0.0]]), return_in_2d=False, return_binned=False
            )
        ...
        def test_2d_symmetry(self):
            ...
            assert gal_x4_lp.profile_image_from_grid(
                grid=np.array([[49.0, 0.0]]), return_in_2d=False, return_binned=False
            ) == pytest.approx(
            ...
            assert gal_x4_lp.profile_image_from_grid(
                grid=np.array([[0.0, 49.0]]), return_in_2d=False, return_binned=False
            ) == pytest.approx(
                gal_x4_lp.profile_image_from_grid(
            ...
            assert gal_x4_lp.profile_image_from_grid(
                grid=np.array([[100.0, 49.0]]), return_in_2d=False, return_binned=False
            ) == pytest.approx(
                gal_x4_lp.profile_image_from_grid(
            ...
            assert gal_x4_lp.profile_image_from_grid(
                grid=np.array([[49.0, 49.0]]), return_in_2d=False, return_binned=False
            ) == pytest.approx(
                gal_x4_lp.profile_image_from_grid(
...
class TestMassProfiles(object):
    ...
    class TestMassWithin:
        ...
        def test__no_mass_profile__returns_none(self):
            gal_no_mp = al.Galaxy(redshift=0.5, light=al.light_profiles.SphericalSersic())
    ...
    class TestSymmetricProfiles:
        def test_1d_symmetry(self):
            ...
            gal_x4_mp = al.Galaxy(redshift=0.5, mass_profile_0=mp_0, mass_profile_1=mp_1)

            assert gal_x4_mp.convergence_from_grid(
                np.array([[1.0, 0.0]]), return_in_2d=False, return_binned=False
            ) == gal_x4_mp.convergence_from_grid(
                grid=np.array([[99.0, 0.0]]), return_in_2d=False, return_binned=False
            )
        ...
        def test_2d_symmetry(self):
            ...
            mp_1 = al.mass_profiles.SphericalIsothermal(centre=(100, 0), einstein_radius=1.0)

            mp_2 = al.mass_profiles.SphericalIsothermal(centre=(0, 100), einstein_radius=1.0)

            mp_3 = al.mass_profiles.SphericalIsothermal(centre=(100, 100), einstein_radius=1.0)
    ...
    class TestEinsteinRadiiMass:
        def test__x2_sis_different_einstein_radii_and_mass__einstein_radii_and_mass_are_sum(
            ...
            mp_0 = al.mass_profiles.SphericalIsothermal(centre=(0.0, 0.0), einstein_radius=1.0)
            mp_1 = al.mass_profiles.SphericalIsothermal(centre=(0.0, 0.0), einstein_radius=0.5)
    ...
    class TestJacobian(object):
        ...
        def test__jacobian_sub_grid_binning_two_component_galaxy(self):
            ...
            pixel_1_from_av_sub_grid = (
                                               a11_sub_grid[0] + a11_sub_grid[1] + a11_sub_grid[2] +
                                               a11_sub_grid[3]
                                       ) / 4
    ...
    class TestCriticalCurvesandCaustics(object):
        def test__compare_tangential_critical_curves_from_magnification_and_lamda_t__reg_grid_two_component_galaxy(
            ...
            critical_curve_tangential_from_magnification = \
            critical_curve_via_magnification_from_galaxy_and_grid(
                galaxy=galaxy, grid=grid
            )[
                0
            ]
...
class TestMassAndLightProfiles(object):
    ...
    def test_multiple_profile(self, lmp_0, lp_0, mp_0):
        gal_multi_profiles = al.Galaxy(redshift=0.5, profile=lmp_0, light=lp_0, sie=mp_0)
...
class TestBooleanProperties(object):
    def test_has_profile(self):
        ...
        assert (
                al.Galaxy(redshift=0.5, light_profile=al.light_profiles.LightProfile()).has_profile is True
        )
        assert al.Galaxy(redshift=0.5, mass_profile=al.mass_profiles.MassProfile()).has_profile is True

    def test_has_light_profile(self):
        assert al.Galaxy(redshift=0.5).has_light_profile is False
        assert (
                al.Galaxy(redshift=0.5, light_profile=al.light_profiles.LightProfile()).has_light_profile
                is True
        )
        assert (
                al.Galaxy(redshift=0.5, mass_profile=al.mass_profiles.MassProfile()).has_light_profile
                is False
        )
    ...
    def test_has_mass_profile(self):
        ...
        assert (
                al.Galaxy(redshift=0.5, light_profile=al.light_profiles.LightProfile()).has_mass_profile
                is False
        )
        assert (
                al.Galaxy(redshift=0.5, mass_profile=al.mass_profiles.MassProfile()).has_mass_profile
                is True
        )
