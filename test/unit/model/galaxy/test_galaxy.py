...
class TestLightProfiles(object):
    class TestIntensity:
        def test__no_light_profiles__intensities_returned_as_0s_of_shape_grid(
            self, grid_stack_7x7
        ):
...
class TestMassProfiles(object):
    class TestConvergence:
        def test__no_mass_profiles__convergence_returned_as_0s_of_shape_grid(
            ...
            convergence = galaxy.convergence_from_grid(grid=grid_stack_7x7.regular)

            assert (
                convergence == np.zeros(shape=grid_stack_7x7.regular.shape[0])
            ).all()
    ...
    class TestPotential:
        def test__no_mass_profiles__potential_returned_as_0s_of_shape_grid(
            ...
            potential = galaxy.potential_from_grid(grid=grid_stack_7x7.regular)
    ...
    class TestDeflectionAngles:
        def test__no_mass_profiles__deflections_returned_as_0s_of_shape_grid(
            ...
            deflections = galaxy.deflections_from_grid(grid=grid_stack_7x7.regular)

            assert (
                deflections == np.zeros(shape=(grid_stack_7x7.regular.shape[0], 2))
            ).all()
        ...
        def test__using_no_mass_profiles__check_reshaping_decorator_of_returned_deflections(
            ...
            assert (
                deflections == np.zeros(shape=(grid_stack_7x7.sub.shape[0], 2))
            ).all()
    ...
    class TestSymmetricProfiles:
        def test_1d_symmetry(self):
            ...
            mp_0 = mp.EllipticalIsothermal(
                axis_ratio=0.5, phi=45.0, einstein_radius=1.0
            )

            mp_1 = mp.EllipticalIsothermal(
    ...
    class TestDeflectionAnglesviaPotential(object):
        ...
        def test__compare_galaxy_deflections_via_potential_and_calculation(self):
            mass_profile_1 = mp.SphericalIsothermal(centre=(0.0, 0.0), einstein_radius=1.0)
        ...
        def test__compare_two_component_galaxy_deflections_via_potential_and_calculation(self):
            mass_profile_1 = mp.SphericalIsothermal(centre=(0.0, 0.0), einstein_radius=1.0)
            mass_profile_2 = mp.SphericalIsothermal(centre=(1.0, 1.0), einstein_radius=1.0)
        ...
        def test__galaxies_with_x1_and_x2_mass_profiles__deflections_via_potential_is_same_individual_profiles(
            ...
            gal_deflections = gal_x2_mp.deflections_via_potential_from_grid(
                grid=grid
            )
    ...
    class TestConvergenceviaJacobian(object):
        ...
        def test__compare_two_component_galaxy_convergence_via_jacobian_and_calculation(self):
            mass_profile_1 = mp.SphericalIsothermal(centre=(0.0, 0.0), einstein_radius=1.0)
            mass_profile_2 = mp.SphericalIsothermal(centre=(1.0, 1.0), einstein_radius=1.0)
        ...
        def test__convergence_sub_grid_binning_two_component_galaxy(self):
            ...
            galaxy = g.Galaxy(
                mass_1=mass_profile_1, mass_2=mass_profile_2, redshift=1
            )
        ...
        def test__galaxies_with_x1_and_x2_mass_profiles__convergence_via_jacobian_is_same_individual_profiles(
            ...
            gal_mp_convergence = gal_x1_mp.convergence_from_jacobian(
                grid=grid
            )
            ...
            gal_convergence = gal_x2_mp.convergence_from_jacobian(
                grid=grid
            )
    ...
    class TestShearviaJacobian(object):
        ...
        def test__galaxies_with_x1_and_x2_mass_profiles__shear_via_jacobian_is_same_individual_profiles(
            ...
            gal_mp_shear = gal_x1_mp.shear_from_jacobian(
                grid=grid
            )
            ...
            gal_shear = gal_x2_mp.shear_from_jacobian(
                grid=grid
            )
    ...
    class TestJacobian(object):
        def test__jacobian_components__reg_grid(self):
            ...
            galaxy = g.Galaxy(
                mass_1=mass_profile_1, redshift=1
            )
    ...
    class TestCriticalCurvesandCaustics(object):
        def test__compare_tangential_critical_curves_from_magnification_and_lamda_t__reg_grid_two_component_galaxy(
            ...
            critical_curves_from_magnification = galaxy.critical_curves_from_grid(grid=grid)
        ...
        def test__compare_tangential_caustic_from_magnification_and_lambda_t__reg_grid_two_component_galaxy(
            ...
            caustic_tangential_from_lambda_t = galaxy.tangential_caustic_from_grid(grid=grid)
...
class TestBooleanProperties(object):
    def test_has_profile(self):
        ...
        assert (
            g.Galaxy(redshift=0.5, light_profile=lp.LightProfile()).has_profile is True
        )
    ...
    def test_has_light_profile(self):
        ...
        assert (
            g.Galaxy(redshift=0.5, light_profile=lp.LightProfile()).has_light_profile
            is True
        )
        assert (
            g.Galaxy(redshift=0.5, mass_profile=mp.MassProfile()).has_light_profile
            is False
        )
    ...
    def test_has_mass_profile(self):
        ...
        assert (
            g.Galaxy(redshift=0.5, light_profile=lp.LightProfile()).has_mass_profile
            is False
        )
        assert (
            g.Galaxy(redshift=0.5, mass_profile=mp.MassProfile()).has_mass_profile
            is True
        )
