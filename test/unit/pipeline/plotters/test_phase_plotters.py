...
def test__lens_fit_for_phase__source_and_lens__depedent_on_input(
    ...
    assert phase_plotter_path + 'fit_lens_subtracted_image.png' in plot_patch.paths
    assert phase_plotter_path + 'fit_lens_plane_model_image.png' not in plot_patch.paths
    assert phase_plotter_path + 'fit_source_plane_model_image.png' in plot_patch.paths
...
def test__hyper_images_for_phase__source_and_lens__depedent_on_input(
        hyper_model_image_5x5, mask_5x5, phase_plotter_path, plot_patch):
