...
class TestImagePassing(object):
    ...
    def test_galaxy_image_dict(self, lens_galaxy, source_galaxy, grid_stack_5x5, convolver_image_5x5):
        ...
        assert len(tracer.galaxy_image_dict_from_convolver_image(convolver_image=convolver_image_5x5)) == 2
        assert lens_galaxy in tracer.galaxy_image_dict_from_convolver_image(convolver_image=convolver_image_5x5)
        assert source_galaxy in tracer.galaxy_image_dict_from_convolver_image(convolver_image=convolver_image_5x5)
    ...
    def test_associate_images_lens(self, lens_instance, lens_result, lens_data_5x5):
        ...
        hyper_model_image_1d = lens_data_5x5.array_1d_from_array_2d(array_2d=lens_result.image_2d_dict["lens_galaxies_lens"])

        assert instance.lens_galaxies.lens.hyper_model_image_1d == pytest.approx(hyper_model_image_1d, 1.0e-4)
        assert instance.lens_galaxies.lens.hyper_galaxy_image_1d == pytest.approx(hyper_model_image_1d, 1.0e-4)
    ...
    def test_associate_images_lens_source(self, lens_source_instance, lens_source_result, lens_data_5x5):
        ...
        hyper_lens_image_1d = lens_data_5x5.array_1d_from_array_2d(array_2d=lens_source_result.image_2d_dict["lens_galaxies_lens"])
        hyper_source_image_1d = lens_data_5x5.array_1d_from_array_2d(array_2d=lens_source_result.image_2d_dict["source_galaxies_source"])

        hyper_model_image_1d = hyper_lens_image_1d + hyper_source_image_1d

        assert instance.lens_galaxies.lens.hyper_model_image_1d == pytest.approx(hyper_model_image_1d, 1.0e-4)
        assert instance.source_galaxies.source.hyper_model_image_1d == pytest.approx(hyper_model_image_1d, 1.0e-4)

        assert instance.lens_galaxies.lens.hyper_galaxy_image_1d == pytest.approx(hyper_lens_image_1d, 1.0e-4)
        assert instance.source_galaxies.source.hyper_galaxy_image_1d == pytest.approx(hyper_source_image_1d, 1.04e-4)
    ...
    def test_associate_images_multi_plane(self, multi_plane_instance, multi_plane_result, lens_data_5x5):
        ...
        hyper_lens_image_1d = lens_data_5x5.array_1d_from_array_2d(array_2d=multi_plane_result.image_2d_dict["galaxies_lens"])
        hyper_source_image_1d = lens_data_5x5.array_1d_from_array_2d(array_2d=multi_plane_result.image_2d_dict["galaxies_source"])

        hyper_model_image_1d = hyper_lens_image_1d + hyper_source_image_1d

        assert instance.galaxies.lens.hyper_galaxy_image_1d == pytest.approx(hyper_lens_image_1d, 1.0e-4)
        assert instance.galaxies.source.hyper_galaxy_image_1d == pytest.approx(hyper_source_image_1d, 1.0e-4)

        assert instance.galaxies.lens.hyper_model_image_1d == pytest.approx(hyper_model_image_1d, 1.0e-4)
        assert instance.galaxies.source.hyper_model_image_1d == pytest.approx(hyper_model_image_1d, 1.0e-4)
    ...
    def test_fit_uses_hyper_fit_correctly_multi_plane(self, multi_plane_instance, multi_plane_result, lens_data_5x5):
        ...
        results_collection.add("phase", multi_plane_result)
        analysis = autolens.pipeline.phase.phase_imaging.MultiPlanePhase.Analysis(
            lens_data=lens_data_5x5, cosmology=cosmo.Planck15, positions_threshold=None, results=results_collection)

        hyper_galaxy = g.galaxy.HyperGalaxy(contribution_factor=1.0, noise_factor=1.0, noise_power=1.0)
        ...
        g0 = g.Galaxy(redshift=0.5, light_profile=multi_plane_instance.galaxies.lens.light,
                      ...
                      hyper_model_image_1d=hyper_model_image_1d, hyper_galaxy_image_1d=hyper_lens_image_1d,
                      hyper_minimum_value=0.0)
        g1 = g.Galaxy(redshift=1.0, light_profile=multi_plane_instance.galaxies.source.light)
    ...
    #         self, lens_source_instance, mask_function_5x5, results_collection_5x5, ccd_data_5x5):
    #
    #     Phase = autolens.pipeline.phase.phase_imaging.LensSourcePlanePhase
    #
    #     phase_5x5 = Phase(optimizer_class=mock_pipeline.MockNLO, mask_function=mask_function_5x5,
    ...
    #
    #     assert (instance.lens_galaxies.lens.hyper_galaxy_image_1d == 2.0*np.ones(9)).all()
    #     assert (instance.source_galaxies.source.hyper_galaxy_image_1d == 3.0*np.ones(9)).all()