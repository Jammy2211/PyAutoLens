...
class TestPhase(object):
    ...
    def test_set_variables(self, phase_5x5):
        ...
        assert phase_5x5.optimizer.variable.lens_galaxies == [gm.GalaxyModel(redshift=0.5)]
    ...
    def test_make_analysis__mask_input_uses_mask__no_mask_uses_mask_function(self, phase_5x5, ccd_data_5x5):
        ...
        mask_input = msk.Mask.circular(shape=ccd_data_5x5.shape, pixel_scale=1, radius_arcsec=1.5)
    ...
    def test_make_analysis__mask_input_uses_mask__inner_mask_radius_included_which_masks_centre(self, phase_5x5, ccd_data_5x5):
    ...
    def test_make_analysis__positions_are_input__are_used_in_analysis(self, phase_5x5, ccd_data_5x5):
        ...
        analysis = phase_5x5.make_analysis(data=ccd_data_5x5, positions=[[[1.0, 1.0], [2.0, 2.0]]])
    ...
    def test__make_analysis__phase_info_is_made(self, phase_5x5, ccd_data_5x5):
        ...
        file_phase_info = "{}/{}".format(phase_5x5.optimizer.phase_output_path, 'phase.info')
    ...
    def test__phase_with_no_inversion__convolver_mapping_matrix_of_lens_data_is_none(self, ccd_data_5x5,
                                                                                     mask_function_5x5):
    ...
    def test__lens_data_is_binned_up(self, ccd_data_5x5, mask_5x5_1_pix, mask_function_5x5_1_pix):
        ...
        binned_up_ccd_data = ccd_data_5x5.new_ccd_data_with_binned_up_arrays(bin_up_factor=2)
        binned_up_mask = mask_5x5_1_pix.binned_up_mask_from_mask(bin_up_factor=2)

        phase_5x5 = autolens.pipeline.phase.phase_imaging.PhaseImaging(phase_name='phase_5x5', bin_up_factor=2,
    ...
    def test__tracer_for_instance__includes_cosmology(self, ccd_data_5x5, mask_function_5x5):
        ...
        phase_5x5 = autolens.pipeline.phase.phase_imaging.LensPlanePhase(mask_function=mask_function_5x5,
        ...
        phase_5x5 = autolens.pipeline.phase.phase_imaging.LensSourcePlanePhase(mask_function=mask_function_5x5,
            lens_galaxies=[lens_galaxy], source_galaxies=[source_galaxy],cosmology=cosmo.FLRW,
            phase_name='test_phase')
        ...
        phase_5x5 = autolens.pipeline.phase.phase_imaging.MultiPlanePhase(mask_function=mask_function_5x5,
            galaxies=[galaxy_0, galaxy_1, galaxy_2], cosmology=cosmo.WMAP7, phase_name='test_phase')
...
class TestResult(object):
    ...
    def test__fit_figure_of_merit__matches_correct_fit_given_galaxy_profiles(self, ccd_data_5x5, mask_function_5x5):
        ...
        phase_5x5 = autolens.pipeline.phase.phase_imaging.LensPlanePhase(
            mask_function=mask_function_5x5, lens_galaxies=[lens_galaxy], cosmology=cosmo.FLRW,
            phase_name='test_phase')
