...
class TestTotalPixels:
    def test__total_image_pixels_from_mask(self):
        ...
        assert al.mask_util.total_pixels_from_mask(mask=mask) == 5
    ...
    def test__total_edge_pixels_from_mask(self):
        ...
        assert al.mask_util.total_edge_pixels_from_mask(mask=mask) == 8
...
class TestEdgePixels(object):
    def test__7x7_mask_one_central_pixel__is_entire_edge(self):
        ...
        edge_pixels = al.mask_util.edge_pixels_from_mask(mask=mask)
...
class TestBorderPixels(object):
    def test__7x7_mask_with_small_numbers_of_pixels__border_is_pixel_indexes(self):
        ...
        border_pixels = al.mask_util.border_pixels_from_mask(mask=mask)
...
class TestSubBorderPixels(object):
    def test__7x7_mask_with_small_numbers_of_pixels__sub_grid_size_1__border_is_pixel_indexes(
        ...
        sub_border_pixels = al.mask_util.sub_border_pixels_from_mask_and_sub_grid_size(
