...
class TestUnmaskedSparseForSparse:
    def test__mask_full_false__image_mask_and_pixel_centres_fully_overlap__each_sparse_maps_to_unmaked_sparse(
        ...
        unmasked_sparse_for_sparse = al.sparse_mapping_util.unmasked_sparse_for_sparse_from_mask_and_pixel_centres(
...
class TestSparseForUnmaskedSparse:
    def test__mask_full_false__image_mask_and_pixel_centres_fully_overlap__each_pix_maps_to_unmaked_pix(
        ...
        sparse_for_unmasked_sparse = al.sparse_mapping_util.sparse_for_unmasked_sparse_from_mask_and_pixel_centres(
            mask=ma,
            unmasked_sparse_grid_pixel_centres=unmasked_sparse_grid_pixel_centres,
...
class TestRegularToSparse:
    def test__simple_cases_for_regular_to_unmasked_sparse_and__sparse_for_unmasked_sparse(
        ...
        sparse_1d_index_for_mask_1d_index = al.sparse_mapping_util.sparse_1d_index_for_mask_1d_index_from_sparse_mappings(
        ...
        assert (
            sparse_1d_index_for_mask_1d_index == np.array([10, 10, 10, 10, 15])
        ).all()
        ...
        assert (
            sparse_1d_index_for_mask_1d_index == np.array([19, 18, 17, 16, 15])
        ).all()
