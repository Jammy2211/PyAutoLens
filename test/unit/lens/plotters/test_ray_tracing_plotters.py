...
def test__image_plane_image_is_output(tracer_5x5, mask_5x5, ray_tracing_plotter_path, plot_patch):

    ray_tracing_plotters.plot_image_plane_image(tracer=tracer_5x5, mask=mask_5x5, extract_array_from_mask=True,
...
def test__convergence_is_output(tracer_5x5, mask_5x5, ray_tracing_plotter_path, plot_patch):

    ray_tracing_plotters.plot_convergence(tracer=tracer_5x5, mask=mask_5x5, extract_array_from_mask=True,
                                          zoom_around_mask=True, cb_tick_values=[1.0], cb_tick_labels=['1.0'],
                                          output_path=ray_tracing_plotter_path, output_format='png')
...
def test__potential_is_output(tracer_5x5, mask_5x5, ray_tracing_plotter_path, plot_patch):

    ray_tracing_plotters.plot_potential(tracer=tracer_5x5, mask=mask_5x5, extract_array_from_mask=True,
                                        zoom_around_mask=True, cb_tick_values=[1.0], cb_tick_labels=['1.0'],
                                        output_path=ray_tracing_plotter_path, output_format='png')
...
def test__deflections_y_is_output(tracer_5x5, mask_5x5, ray_tracing_plotter_path, plot_patch):

    ray_tracing_plotters.plot_deflections_y(tracer=tracer_5x5, mask=mask_5x5, extract_array_from_mask=True,
                                            zoom_around_mask=True, cb_tick_values=[1.0], cb_tick_labels=['1.0'],
                                            output_path=ray_tracing_plotter_path, output_format='png')
...
def test__deflections_x_is_output(tracer_5x5, mask_5x5, ray_tracing_plotter_path, plot_patch):

    ray_tracing_plotters.plot_deflections_x(tracer=tracer_5x5, mask=mask_5x5, extract_array_from_mask=True,
                                            zoom_around_mask=True, cb_tick_values=[1.0], cb_tick_labels=['1.0'],
                                            output_path=ray_tracing_plotter_path, output_format='png')
...
def test__tracer_sub_plot_output(tracer_5x5, mask_5x5, ray_tracing_plotter_path, plot_patch):

    ray_tracing_plotters.plot_ray_tracing_subplot(
        tracer=tracer_5x5, mask=mask_5x5, extract_array_from_mask=True, zoom_around_mask=True,
        output_path=ray_tracing_plotter_path, output_format='png')

    assert ray_tracing_plotter_path + 'tracer.png' in plot_patch.paths


def test__tracer_individuals__dependent_on_input(tracer_5x5, mask_5x5, ray_tracing_plotter_path, plot_patch):
...
def test__plot_ray_tracing_for_phase__dependent_on_input(tracer_5x5, mask_5x5, ray_tracing_plotter_path, plot_patch):

    ray_tracing_plotters.plot_ray_tracing_for_phase(
        tracer=tracer_5x5, during_analysis=False, mask=mask_5x5, positions=None,
