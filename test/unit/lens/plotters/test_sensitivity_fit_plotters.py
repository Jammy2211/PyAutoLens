...
def test__fit_sub_plot__output_dependent_on_config(sensitivity_fit_5x5, sensitivity_fit_plotter_path, plot_patch):

    sensitivity_fit_plotters.plot_fit_subplot(fit=sensitivity_fit_5x5, should_plot_mask=True, extract_array_from_mask=True,
