...
def test__fit_individuals__source_and_lens__depedent_on_input(
    ...
    assert (
        lens_fit_plotter_path + "fit_normalized_residual_map.png"
    ...
    assert (
        lens_fit_plotter_path + "fit_subtracted_image_of_plane_0.png"
        in plot_patch.paths
    )
    ...
    assert (
        lens_fit_plotter_path + "fit_subtracted_image_of_plane_1.png"
        in plot_patch.paths
    )
