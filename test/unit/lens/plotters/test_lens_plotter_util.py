...
def test__image_is_output(fit, lens_plotter_util_path, plot_patch):
    ...
    lens_plotter_util.plot_image(fit=fit, mask=fit.mask_2d, extract_array_from_mask=True, zoom_around_mask=True,
...
def test__noise_map_is_output(fit, lens_plotter_util_path, plot_patch):
    lens_plotter_util.plot_noise_map(fit=fit, mask=fit.mask_2d, extract_array_from_mask=True, zoom_around_mask=True,
                                     cb_tick_values=[1.0], cb_tick_labels=['1.0'],
                                     output_path=lens_plotter_util_path, output_format='png')
...
def test__signal_to_noise_map_is_output(fit, lens_plotter_util_path, plot_patch):
    lens_plotter_util.plot_signal_to_noise_map(fit=fit, mask=fit.mask_2d, extract_array_from_mask=True,
...
def test__model_image_is_output(fit, lens_plotter_util_path, plot_patch):
    lens_plotter_util.plot_model_data(fit=fit, mask=fit.mask_2d, extract_array_from_mask=True, zoom_around_mask=True,
                                      cb_tick_values=[1.0], cb_tick_labels=['1.0'],
                                      output_path=lens_plotter_util_path, output_format='png')
...
def test__residual_map_is_output(fit, lens_plotter_util_path, plot_patch):
    lens_plotter_util.plot_residual_map(fit=fit, mask=fit.mask_2d, extract_array_from_mask=True, zoom_around_mask=True,
                                        cb_tick_values=[1.0], cb_tick_labels=['1.0'],
                                        output_path=lens_plotter_util_path, output_format='png')
...
def test__chi_squared_map_is_output(fit, lens_plotter_util_path, plot_patch):
    lens_plotter_util.plot_chi_squared_map(fit=fit, mask=fit.mask_2d, extract_array_from_mask=True, zoom_around_mask=True,
                                           cb_tick_values=[1.0], cb_tick_labels=['1.0'],
                                           output_path=lens_plotter_util_path, output_format='png')
