...
def make_ccd_data_7x7(image_7x7, psf_3x3, noise_map_7x7, background_noise_map_7x7,
                      poisson_noise_map_7x7,
                      exposure_time_map_7x7, background_sky_map_7x7):
...
def make_mask_7x7():
    array = np.array([[True, True,  True,  True,  True, True, True],
...
def make_image_1d_7x7(image_7x7, mask_7x7):
    return mask_7x7.array_1d_from_array_2d(
        array_2d=image_7x7)
...
def make_grid_stack_7x7(regular_grid_7x7, sub_grid_7x7, blurring_grid_7x7):
    return mock_grids.MockGridStack(
        regular=regular_grid_7x7, sub=sub_grid_7x7, blurring=blurring_grid_7x7)


@pytest.fixture(name="grid_stack_simple")
def make_grid_stack_simple(regular_grid_7x7, sub_grid_7x7, blurring_grid_7x7):
...
def make_gal_data_7x7(image_7x7, noise_map_7x7):
    return gd.GalaxyData(image=image_7x7, noise_map=noise_map_7x7,
                         pixel_scale=image_7x7.pixel_scale)
...
def make_gal_fit_data_7x7_deflections_y(gal_data_7x7, mask_7x7):
    return gd.GalaxyFitData(
        galaxy_data=gal_data_7x7, mask=mask_7x7, sub_grid_size=2,
...
def make_plane_7x7(gal_x1_lp_x1_mp, grid_stack_7x7):
    return pl.Plane(
        galaxies=[gal_x1_lp_x1_mp], grid_stack=grid_stack_7x7,
...
def make_sensitivity_fit_7x7(lens_data_7x7):
    ...
    return sensitivity_fit.SensitivityProfileFit(
        lens_data=lens_data_7x7, tracer_normal=tracer_normal,
...
def make_contribution_map_7x7(hyper_model_image_7x7, hyper_galaxy_image_0_7x7,
                              hyper_galaxy):
...
def make_results(hyper_model_image_7x7, hyper_galaxy_image_0_7x7,
