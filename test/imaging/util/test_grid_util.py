...
class TestGrid2d:
    ...
    def test__array_3x3__sets_up_arcsecond_grid(self):
        ...
        grid_2d = grid_util.image_grid_2d_from_shape_pixel_scales_and_origin(shape=(3, 3), pixel_scales=(2.0, 1.0))
    ...
    def test__array_4x4_and_different_pixel_scale__sets_up_arcsecond_grid(self):
        ...
        grid_2d = grid_util.image_grid_2d_from_shape_pixel_scales_and_origin(shape=(4, 4), pixel_scales=(0.5, 0.5))
    ...
    def test__array_2x3__sets_up_arcsecond_grid(self):
        grid_2d = grid_util.image_grid_2d_from_shape_pixel_scales_and_origin(shape=(2, 3), pixel_scales=(1.0, 1.0))

        assert (grid_2d == np.array([[[0.5, -1.], [0.5, 0.], [0.5, 1.]],
                                     [[-0.5, -1.], [-0.5, 0.], [-0.5, 1.]]])).all()

    def test__array_3x2__sets_up_arcsecond_grid(self):
        grid_2d = grid_util.image_grid_2d_from_shape_pixel_scales_and_origin(shape=(3, 2), pixel_scales=(1.0, 1.0))
...
class TestGrid1d:
    ...
    def test__array_3x3__sets_up_arcsecond_grid(self):
        ...
        grid_2d = grid_util.image_grid_1d_from_shape_pixel_scales_and_origin(shape=(3, 3), pixel_scales=(2.0, 1.0))
    ...
    def test__array_4x4_and_different_pixel_scale__sets_up_arcsecond_grid(self):
        ...
        grid_2d = grid_util.image_grid_1d_from_shape_pixel_scales_and_origin(shape=(4, 4), pixel_scales=(0.5, 0.5))
    ...
    def test__array_2x3__sets_up_arcsecond_grid(self):
        grid_2d = grid_util.image_grid_1d_from_shape_pixel_scales_and_origin(shape=(2, 3), pixel_scales=(1.0, 1.0))

        assert (grid_2d == np.array([[0.5, -1.], [0.5, 0.], [0.5, 1.],
                                     [-0.5, -1.], [-0.5, 0.], [-0.5, 1.]])).all()

    def test__array_3x2__sets_up_arcsecond_grid(self):
        grid_2d = grid_util.image_grid_1d_from_shape_pixel_scales_and_origin(shape=(3, 2), pixel_scales=(1.0, 1.0))
...
class TestImageGridMasked(object):
    ...
    def test__setup_3x3_image_1_coordinate_in_mask(self):
        ...
        image_grid = grid_util.image_grid_1d_masked_from_mask_pixel_scales_and_origin(mask=mask, pixel_scales=(3.0, 6.0))
    ...
    def test__setup_3x3_image__five_coordinates_in_mask(self):
        ...
        image_grid = grid_util.image_grid_1d_masked_from_mask_pixel_scales_and_origin(mask=mask, pixel_scales=(6.0, 3.0))
    ...
    def test__setup_4x4_image__ten_coordinates_in_grid__new_pixel_scale(self):
        ...
        image_grid = grid_util.image_grid_1d_masked_from_mask_pixel_scales_and_origin(mask=mask, pixel_scales=(1.0, 1.0))
    ...
    def test__setup_3x4_image__six_grid(self):
        ...
        image_grid = grid_util.image_grid_1d_masked_from_mask_pixel_scales_and_origin(mask=mask, pixel_scales=(3.0, 3.0))
