...
from autolens.lensing.plotters import lensing_fit_hyper_plotters
...
def test__fit_sub_plot_hyper_lens_only__output_dependent_on_config(fit_lens_only, fit_hyper_lens_only, general_config,
    ...
    lensing_fit_hyper_plotters.plot_fit_subplot(fit_hyper=fit_hyper_lens_only, fit=fit_lens_only, should_plot_mask=True,
                                          output_path=lensing_fit_plotter_path,
                                          output_filename='hyper_lensing_fit', output_format='png')
    assert os.path.isfile(path=lensing_fit_plotter_path + 'hyper_lensing_fit.png')
    os.remove(path=lensing_fit_plotter_path + 'hyper_lensing_fit.png')


def test__fit_individuals__hyper_lens_only__depedent_on_config(fit_hyper_lens_only, fit_lens_only, general_config,
                                                               lensing_fit_plotter_path):

    lensing_fit_hyper_plotters.plot_fit_individuals(fit_hyper=fit_hyper_lens_only, fit=fit_lens_only,
    ...
    assert not os.path.isfile(path=lensing_fit_plotter_path + 'fit_hyper_chi_squared_map.png')

    assert os.path.isfile(path=lensing_fit_plotter_path + 'fit_hyper_noise_map.png')
    os.remove(path=lensing_fit_plotter_path + 'fit_hyper_noise_map.png')
