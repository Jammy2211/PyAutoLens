...
class TestTraceImageAndSoure(object):
    ...
    class TestSetup:
        ...
        def test__image_grid__sis_lens__image_coordinates_are_grid_and_source_plane_is_deflected(self, all_grids, galaxy_mass_sis):
...
class TestPlane(object):
    ...
    class TestImageFromGalaxies:
        ...
        def test__same_as_above__now_galaxy_entered_3_times__intensities_triple(self, galaxy_light_sersic):
            ...
            plane = ray_tracing.Plane(galaxies=[galaxy_light_sersic,galaxy_light_sersic, galaxy_light_sersic], grids=all_grids)
            image = plane.generate_image_of_galaxy_light_profiles()
