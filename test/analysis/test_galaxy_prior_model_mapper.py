...
class TestCase:
    def test_integration(self):
        ...
        source_galaxy_prior = gp.GalaxyPrior(variable_redshift=True,
                                             light_profile_one=light_profiles.EllipticalExponentialLP,
                                             light_profile_2=light_profiles.EllipticalSersicLP, config=config)
        ...
        lens_galaxy_prior = gp.GalaxyPrior(variable_redshift=True, light_profile=light_profiles.EllipticalExponentialLP,
                                           mass_profile=mass_profiles.EllipticalExponentialMP,
