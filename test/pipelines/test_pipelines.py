...
#
#
# @pytest.fixture(pipeline_name="initializer_pipeline")
...
#
#
# @pytest.fixture(pipeline_name="results_2")
# def make_results_2():
#     const = model_mapper.ModelInstance()
#     var = model_mapper.ModelMapper()
...
#
#
# @pytest.fixture(pipeline_name="results_3")
# def make_results_3():
#     const = model_mapper.ModelInstance()
#     var = model_mapper.ModelMapper()
#     var.lens_galaxy = gp.GalaxyPrior(sie=mass_profiles.SphericalIsothermalMP,
...
#         lensing = phase1.make_analysis(image)
#
#         assert isinstance(phase1.lens_galaxies[0], gp.GalaxyPrior)
#
#         assert lensing.masked_image == np.ones((716,))
#         assert lensing.masked_image.sub_grid_size == 1
#         assert lensing.previous_results is None
#
...
#         lensing = phase2.make_analysis(image, previous_results)
#
#         assert lensing.masked_image == np.full((704,), 0.5)
#
...
#
#         lensing = phase3.make_analysis(image, previous_results)
#
