...
# ao_tracer = ray_tracing.Tracer(lens_galaxies=[lens_galaxies], source_galaxies=[source_pix], image_plane_grids=ao.grids)
...
@tools.tick_toc_x1
def lsst_solution():
    lsst_reconstructed.log_determinant_of_matrix_cholesky(lsst_reconstructed.covariance_regularization)

@tools.tick_toc_x1
def euclid_solution():
    euclid_reconstructed.log_determinant_of_matrix_cholesky(euclid_reconstructed.covariance_regularization)

@tools.tick_toc_x1
def hst_solution():
    hst_reconstructed.log_determinant_of_matrix_cholesky(hst_reconstructed.covariance_regularization)

@tools.tick_toc_x1
def hst_up_solution():
    hst_up_reconstructed.log_determinant_of_matrix_cholesky(hst_up_reconstructed.covariance_regularization)

@tools.tick_toc_x1
def ao_solution():
    ao_reconstructed.log_determinant_of_matrix_cholesky(ao_reconstructed.covariance_regularization)
