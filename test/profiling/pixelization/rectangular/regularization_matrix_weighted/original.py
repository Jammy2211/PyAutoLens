...
lsst_regularization_weights = pix.regularization_weights_from_pix_signals(lsst_pix_signals)
euclid_regularization_weights = pix.regularization_weights_from_pix_signals(euclid_pix_signals)
hst_regularization_weights = pix.regularization_weights_from_pix_signals(hst_pix_signals)
hst_up_regularization_weights = pix.regularization_weights_from_pix_signals(hst_up_pix_signals)
ao_regularization_weights = pix.regularization_weights_from_pix_signals(ao_pix_signals)
