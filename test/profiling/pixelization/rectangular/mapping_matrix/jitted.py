...
class Pixelization(object):
    ...
    def mapping_matrix_from_sub_to_pix(self, sub_to_pix, grids):
        ...
        mapping_matrix = np.zeros((grids._image_plane_images.shape[0], self.pixels))
    ...
    def mapping_matrix_from_sub_to_pix_jitted(self, sub_to_pix, grids):
        ...
        return self.mapping_matrix_from_sub_to_pix_jit(sub_to_pix, self.pixels, grids._image_plane_images,
