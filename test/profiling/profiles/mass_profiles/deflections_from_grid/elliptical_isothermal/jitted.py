...
class EllipticalIsothermal(geometry_profiles.EllipticalProfile):
    ...
    def deflections_from_grid(self, grid):
        ...
        try:
            ...
            return np.multiply(factor, np.vstack((deflection_x, deflection_y)).T)
    ...
    def deflections_from_grid_jitted(self, grid):
        return self.deflections_from_grid_jit(grid, self.axis_ratio, self.einstein_radius_rescaled)
