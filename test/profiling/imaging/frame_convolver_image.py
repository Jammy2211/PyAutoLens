...
euclid_kernel_convolver = euclid.masked_image.convolver.convolver_for_kernel(euclid._image_plane_image.psf.trim(kernel_shape))
...
hst_up_kernel_convolver = hst_up.masked_image.convolver.convolver_for_kernel(hst_up._image_plane_image.psf.trim(kernel_shape))
