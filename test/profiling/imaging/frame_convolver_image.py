...
lsst_kernel_convolver = lsst.masked_image.convolver.convolver_for_kernel(lsst.image_plane_images_.psf.trim_around_centre(kernel_shape))
...
euclid_kernel_convolver = euclid.masked_image.convolver.convolver_for_kernel(
    euclid.image_plane_images_.psf.trim_around_centre(kernel_shape))
...
hst_kernel_convolver = hst.masked_image.convolver.convolver_for_kernel(hst.image_plane_images_.psf.trim_around_centre(kernel_shape))
...
hst_up_kernel_convolver = hst_up.masked_image.convolver.convolver_for_kernel(
    hst_up.image_plane_images_.psf.trim_around_centre(kernel_shape))
...
ao_kernel_convolver = ao.masked_image.convolver.convolver_for_kernel(ao.image_plane_images_.psf.trim_around_centre(kernel_shape))
