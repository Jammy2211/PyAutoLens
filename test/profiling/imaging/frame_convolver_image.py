...
lsst_kernel_convolver = lsst.masked_image.convolver.convolver_for_kernel(lsst._image_plane_images.psf.trim_around_centre(kernel_shape))
...
euclid_kernel_convolver = euclid.masked_image.convolver.convolver_for_kernel(
    euclid._image_plane_images.psf.trim_around_centre(kernel_shape))
...
hst_kernel_convolver = hst.masked_image.convolver.convolver_for_kernel(hst._image_plane_images.psf.trim_around_centre(kernel_shape))
...
hst_up_kernel_convolver = hst_up.masked_image.convolver.convolver_for_kernel(
    hst_up._image_plane_images.psf.trim_around_centre(kernel_shape))
...
ao_kernel_convolver = ao.masked_image.convolver.convolver_for_kernel(ao._image_plane_images.psf.trim_around_centre(kernel_shape))
