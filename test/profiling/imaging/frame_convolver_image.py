...
lsst_kernel_convolver = lsst.masked_image.convolver.convolver_for_kernel(lsst.image_plane_image.psf.trim(kernel_shape))

assert lsst_kernel_convolver.convolve_image(image_array=lsst_image, blurring_array=lsst_blurring_image) == \
       pytest.approx(lsst_kernel_convolver.convolve_image(image_array=lsst_image, blurring_array=lsst_blurring_image), 1e-4)
...
euclid_kernel_convolver = euclid.masked_image.convolver.convolver_for_kernel(euclid.image_plane_image.psf.trim(kernel_shape))

assert euclid_kernel_convolver.convolve_image(image_array=euclid_image, blurring_array=euclid_blurring_image) == \
       pytest.approx(euclid_kernel_convolver.convolve_image(image_array=euclid_image, blurring_array=euclid_blurring_image), 1e-4)
...
hst_kernel_convolver = hst.masked_image.convolver.convolver_for_kernel(hst.image_plane_image.psf.trim(kernel_shape))

assert hst_kernel_convolver.convolve_image(image_array=hst_image, blurring_array=hst_blurring_image) == \
       pytest.approx(hst_kernel_convolver.convolve_image(image_array=hst_image, blurring_array=hst_blurring_image), 1e-4)
...
hst_up_kernel_convolver = hst_up.masked_image.convolver.convolver_for_kernel(hst_up.image_plane_image.psf.trim(kernel_shape))

assert hst_up_kernel_convolver.convolve_image(image_array=hst_up_image, blurring_array=hst_up_blurring_image) == \
       pytest.approx(hst_up_kernel_convolver.convolve_image(image_array=hst_up_image, blurring_array=hst_up_blurring_image), 1e-4)
...
ao_kernel_convolver = ao.masked_image.convolver.convolver_for_kernel(ao.image_plane_image.psf.trim(kernel_shape))
