...
def test_lens_x1_source_x1_inversion_pipeline():
...
def make_lens_x1_source_x1_inversion_pipeline(pipeline_name):
    ...
    class SourcePix(ph.LensSourcePlanePhase):
        ...
        def pass_priors(self, previous_results):
            ...
            self.source_galaxies[0].mapper.shape.shape_0 = 20.0
            self.source_galaxies[0].mapper.shape.shape_1 = 20.0
...
if __name__ == "__main__":
    test_lens_x1_source_x1_inversion_pipeline()
