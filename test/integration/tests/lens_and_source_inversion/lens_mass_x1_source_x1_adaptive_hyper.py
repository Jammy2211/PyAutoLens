...
def make_pipeline(test_name):
    ...
    phase2 = HyperLensSourcePlanePhase(
        ...
        lens_galaxies=dict(lens=gm.GalaxyModel(redshift=0.5, mass=mp.EllipticalIsothermal, hyper_galaxy=g.HyperGalaxy)),
        source_galaxies=dict(source=gm.GalaxyModel(redshift=1.0, pixelization=pix.VoronoiMagnification,
                                                   regularization=reg.Constant, hyper_galaxy=g.HyperGalaxy)),
        optimizer_class=nl.MultiNest)
