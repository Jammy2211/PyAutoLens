...
test_name = "lens_mass_x1_source_x1_use_interp_pixel_scale"
...
def make_pipeline(test_name):
    ...
    phase1 = ph.LensSourcePlanePhase(lens_galaxies=dict(lens=gm.GalaxyModel(mass=mp.EllipticalPowerLaw)),
                                     source_galaxies=dict(source=gm.GalaxyModel(light=lp.EllipticalSersic)),
                                     optimizer_class=nl.MultiNest, interp_pixel_scale=0.3,
