...
from autofit import phase as autofit_ph
...
def make_pipeline(test_name):
    ...
    class GridPhase(autofit_ph.as_grid_search(phase_class=autolens.pipeline.phase.phase_imaging.LensPlanePhase, parallel=True)):
