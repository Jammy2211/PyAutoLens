...
def pipeline():
    pipeline_name = "pair_floats_then_set_constant"
    data_name = '/pair_floats_then_set_constant'
...
def make_pipeline(pipeline_name):
    class MMPhase(ph.LensPlanePhase):
      ...
      #       self.lens_galaxies[0].sersic.axis_ratio = 0.5
            self.lens_galaxies[0].sersic.intensity = 0.5
