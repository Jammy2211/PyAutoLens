...
def make_pipeline(test_name):
    ...
    class MMPhase2(ph.LensPlanePhase):
        ...
        def pass_priors(self, results):
            ...
            print(results.from_phase('phase_1').constant.lens.light.centre)

            centre_value = results.from_phase('phase_1').constant.lens.light.centre
