...
def pipeline():
    ...
    pipeline_name = "const_x2_profile"
    data_name = '/const_x2_profile'
...
def make_pipeline(pipeline_name):
    ...
    phase1 = MMPhase(lens_galaxies=[gp.GalaxyModel(sersic0=lp.EllipticalSersic, sersic1=lp.EllipticalSersic)],
