...
def test_lens_x2_gal_hyper_pipeline():
    ...
    bulge_0 = lp.EllipticalSersicLP(centre=(-2.0, -2.0), axis_ratio=0.9, phi=90.0, intensity=1.0,
                                    effective_radius=1.0, sersic_index=4.0)
    disk_0 = lp.EllipticalSersicLP(centre=(-2.0, -2.0), axis_ratio=0.6, phi=90.0, intensity=1.0,
                                   effective_radius=2.5, sersic_index=1.0)
    bulge_1 = lp.EllipticalSersicLP(centre=(2.0, 2.0), axis_ratio=0.9, phi=90.0, intensity=1.0,
                                    effective_radius=1.0, sersic_index=4.0)
    disk_1 = lp.EllipticalSersicLP(centre=(2.0, 2.0), axis_ratio=0.6, phi=90.0, intensity=1.0,
                                   effective_radius=2.5, sersic_index=1.0)
