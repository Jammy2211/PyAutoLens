...
phase = ph.LensSourcePlanePhase(lens_galaxies=dict(lens=gm.GalaxyModel(mass=mp.EllipticalPowerLaw)),
                                 source_galaxies=dict(source=gm.GalaxyModel(light=lp.EllipticalSersic)),
                                 optimizer_class=nl.MultiNest, interp_pixel_scale=interp_pixel_scale,
                                 phase_name='phase_image_type_' + data_type + '_interp_pixel_scale_' +
                                            str(interp_pixel_scale))
