...
noise_term_0 = fitting.noise_term_from_data(noise)
...
noise_term_1 = fitting.noise_term_from_data(noise)
...
noise_term_2 = fitting.noise_term_from_data(noise)
...
noise_term_3 = fitting.noise_term_from_data(noise)
